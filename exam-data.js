window.EXAM_PREP_DATA = {
  "assisting_passengers": [
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Jos paikka ei ole turvallinen pysähtymiselle etsit toisen paikan, koska vastuullasi on asiakkaan turvallinen ajoneuvosta poistuminen."
        },
        {
          "letter": "B",
          "text": "Vaikka paikka ei ole turvallinen pysähtymiselle voit pysähtyä, koska asiakkaalla on oikeus valita pysähtymispaikka."
        },
        {
          "letter": "C",
          "text": "Asiakkaalla on velvollisuus maksaa mahdollinen sakkosumma, mikäli hän on"
        }
      ],
      "correct": "A",
    ...
    {
      "id": 11,
      "text": "Miten kuljettajan tulee toimia kun hän huomaa perille päästyään ettei saa asiakasta hereille matkan päätyttyä ja kyyti on maksamatta?",
      "options": [
        {
          "letter": "A",
          "text": "Otetaan asiakkaan lompakosta maksukortti ja veloitetaan kyyti lähimaksulla."
        },
        {
          "letter": "B",
          "text": "Kuljettajan tulee puheella ensin yrittää herätellä asiakasta ja tarvittaessa soittaa poliisi paikalle."
        },
        {
          "letter": "C",
          "text": "Kirjoittaa asiakkaalle laskun ja sijoittaa sen asiakkaan taskuun. Asiakas tulee siirtää taksin ulkopuolelle heräilemään ja soittaa poliisi paikalle."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 19,
      "text": "Olet ottanut asiakkaan kyytiin paikkakuntasi taksiasemalta. Olette ajaneet hyvän matkaa, kun taksin puhelin soi. Huomaat, että handsfree-laite on jäänyt kotiin. Mitä teet?",
      "options": [
        {
          "letter": "A",
          "text": "Vastaan puhelimeen normaalisti pahoittelen asiakkaalle puhelimen aiheuttamaa häiriöstä ja vastaan sitten puheluun."
        },
        {
          "letter": "B",
          "text": "Pysähdyn tienvarteen, jotta voin kirjoittaa ylös välttämättömiä tietoja. Voin pitää taksimittarin päällä."
        },
        {
          "letter": "C",
          "text": "Pahoittelen asiakkaalle puhelimen aiheuttamaa häiriötä enkä vastaa siihen; soitan takaisin kyydin päätyttyä."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 31,
      "text": "Miten toimit, kun asiakas saa epileptisen kohtauksen kuljetuksen aikana?",
      "options": [
        {
          "letter": "A",
          "text": "Pysäytät ajoneuvon turvalliseen paikkaan ja pidät tiukasti kiinni asiakkaasta, jotta hän ei satuttaisi itseään kouristuskohtauksen aikana. Kun kouristukset vähentyvät, käännät henkilön kylkiasentoon."
        },
        {
          "letter": "B",
          "text": "Pysäytät ajoneuvon turvalliseen paikkaan ja huolehdit ettei asiakas kolhi päätään, mutta et pyri estämään kouristusliikkeitä. Kun kouristukset vähentyvät, käännät henkilön kylkiasentoon."
        },
        {
          "letter": "C",
          "text": "Jatkat ajamista ja pidät toisella kädellä asiakasta paikoillaan, koska epileptinen"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Kieltäydyt häntä kuljettamasta."
        },
        {
          "letter": "B",
          "text": "Jätät asiakkaan lähimmälle pysäkille tai kadulle ja jatkat työvuoroasi."
        },
        {
          "letter": "C",
          "text": "Huolehdit asiakkaan turvallisuudesta, yrität selvittää määränpään ja tarvittaessa soitat poliisin paikalle."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 51,
      "text": "Miten toimit, kun saavut noutamaan asiakasta ja huomaat hänen odottavan pysähtymiskieltomerkin vaikutusalueella?",
      "options": [
        {
          "letter": "A",
          "text": "Et voi pysähtyä, joten poistut paikalta ilman asiakasta ja hylkäät kyydin."
        },
        {
          "letter": "B",
          "text": "Pysäytät autosi sallittuun paikkaan ja käyt tarvittaessa kävellen ohjaamaan asiakkaan kyytiin."
        },
        {
          "letter": "C",
          "text": "Otat asiakkaan kyytiin, koska taksikuljetus on poikkeus, joten kieltomerkki ei koske"
        }
      ],
      "correct": "B",
    ...
    {
      "id": 52,
      "text": "Mikä on oikea tapa toimia, kun asiakas pyytää pysähtymään paikassa, jossa pysähtyminen on kielletty?",
      "options": [
        {
          "letter": "A",
          "text": "Asiakas voi aina päättää pysähtymispaikan."
        },
        {
          "letter": "B",
          "text": "Et voi pysähtyä paikkaan, jossa pysähtyminen on kielletty."
        },
        {
          "letter": "C",
          "text": "Pysähtymissäännöistä voi perustellusta syystä poiketa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 69,
      "text": "Mikä seuraavista on paras tapa kiinnittää kyydissä oleva asiakas, kun hän on paareilla selinmakuulla?",
      "options": [
        {
          "letter": "A",
          "text": "Hartiavyöllä, lantiovyöllä ja jalkavyöllä."
        },
        {
          "letter": "B",
          "text": "Hartiavyöllä ja lantiovyöllä."
        },
        {
          "letter": "C",
          "text": "Lantiovyöllä ja jalkavyöllä."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 72,
      "text": "Mikä seuraavista on paras tapa toimia, jos asiakas ei voi käyttää turvavyötä siitä syystä, että turvavyöt ovat liian lyhyet?",
      "options": [
        {
          "letter": "A",
          "text": "Tilaat asiakkaalle toisen taksin, jossa asiakasta on turvallisempi kuljettaa."
        },
        {
          "letter": "B",
          "text": "Annat asiakkaan matkustaa ilman turvavyötä."
        },
        {
          "letter": "C",
          "text": "Jatkat turvavyön pituutta jatkopalalla, joka sinun tulee pitää aina mukana autossa."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 77,
      "text": "Mitä sinun tulee toimia saattaessasi kotiinsa asiakasta, joka ei kykene huolehtimaan itsestään, ja sovittu avustaja ei ole vastaanottamassa häntä?",
      "options": [
        {
          "letter": "A",
          "text": "Sinun tulee aina viedä asiakas takaisin lähtopaikkaansa"
        },
        {
          "letter": "B",
          "text": "Sinä voit jättää asiakkaan esimerkiksi asiakkaan naapurin luokse."
        },
        {
          "letter": "C",
          "text": "Sinun tulee odottaa asiakkaan kanssa, kunnes avustaja saapuu paikalle."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 80,
      "text": "Jos asiakas on erittäin humalassa, mitä teet?",
      "options": [
        {
          "letter": "A",
          "text": "Soitat poliisille tai viet hänet lähimmälle poliisiasemalle."
        },
        {
          "letter": "B",
          "text": "Pidät hänet autossa ja odotat, että hän selviää."
        },
        {
          "letter": "C",
          "text": "Jätät hänet pois autosta."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 86,
      "text": "Kuka on vastuussa paareilla olevan asiakkaan turvavöistä, jonka olet noutanut sairaalasta?",
      "options": [
        {
          "letter": "A",
          "text": "Asiakas itse"
    ...
    {
      "id": 159,
      "text": "Asiakkaanasi oleva kiireinen herra Möttönen pyytää sinua pysähtymään hyvin vilkkaasti liikennöidyllä paikkaan, jotta hän voi jäädä pois. Mikä seuraavista tilannetta koskevista väittämistä on oikean?",
      "options": [
        {
          "letter": "A",
          "text": "Herra mättösellä on oikeus valita pysähtymispaikka, sillä hän maksaa kyydistä."
        },
        {
          "letter": "B",
          "text": "Herra mättösellä on velvollisuus maksaa mahdollinen sakkomaksu. mikäli hän on pyytänyt pysähtymään kielletyssä paikassa."
        },
        {
          "letter": "C",
          "text": "Asiakkaan turvallinen autoon tulo ja poistaminen on aina kuljettajan sinun vastuullesi, joten jos pysähtymispaikka on sellaiseksi, ettei herra mättönen voi siinä poistua, etsit paremmin paikan."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 186,
      "text": "Talvet saattavat suomessa olla erittäin kylmiä. eräänä helmikuun torsaiyönä ulkoma on -30 astetta pakkasta. Olet saanut lentokentältä varsin väsyneen oloisen asiakkaan, joka on nauttinut muutaman alkoholiannoksen. kyyti sujuu oikein mainiosti ja perille päästyäänne asiakas lähtee hoippumaan kohti kotioveaan. Miten toimit?",
      "options": [
        {
          "letter": "A",
          "text": "Varmistat, että asiakas pääsee kotiovesta sisään. Tämä jälkeen voit jatkaa matkaa."
        },
        {
          "letter": "B",
          "text": "Asiakas poistuessa taksista hän ei ole enää sinun vastuullasi, joten voit jatkaa matkaasi."
        },
        {
          "letter": "C",
          "text": "Puhaluttat asiakkaan ennen kuin päästät hänet ulos autosta. Jos hän puhaltaa yli 0,5 % Viet hänet poliisin selviämisasemalle."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 204,
      "text": "Miten varmistat, että lemmikkieläimet matkustavat turvallisesti ajoneuvossa?",
      "options": [
        {
          "letter": "A",
          "text": "Lemmikkieläimet voivat istua vapaasti auton sisällä."
        },
        {
          "letter": "B",
          "text": "Lemmikkieläimet matkustavat kuljettajan sylissä."
        },
        {
          "letter": "C",
          "text": "Lemmikkieläimet matkustavat omassa häkissään tai kiinnitettynä turvavöihin takaistuimella."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: How do you ensure pets travel safely in the vehicle?\nA: Pets may sit freely inside the car.\nB: Pets travel in the driver's lap.\nC: Pets travel in their own carrier or secured with seat belts on the back seat.\n\n--- Keywords ---\nlemmikkieläimet = pets\nhäkki = carrier / cage\nturvavyöt = seat belts\ntakaistuin = back seat\nkiinnitetty = secured\n\n--- Explanation ---\nPets must travel in a carrier or be properly secured — not loose or on the driver's lap.\n\nCorrect answer: C"
    },
    {
      "id": 206,
      "text": "Miten toimitaan, jos asiakas pyytää sinua pysäyttämään vaarallisella alueella?",
      "options": [
        {
          "letter": "A",
          "text": "Pysäytät heti, koska asiakas niin pyytää."
        },
        {
          "letter": "B",
          "text": "Kieltäydyt pysäyttämästä ja ajat asiakkaan määränpäähän."
        },
        {
          "letter": "C",
          "text": "Selität asiakkaalle tilanteen vaarallisuuden ja etsit turvallisen pysäköintipaikan lähettyviltä."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 209,
      "text": "Miten toimit, jos asiakas tarvitsee apua matkatavaroiden kanssa ja sinulla on kiire seuraavaan tilaukseen?",
      "options": [
        {
          "letter": "A",
          "text": "Pyydät asiakasta kantamaan matkatavaransa itse."
        },
        {
          "letter": "B",
          "text": "Avustat asiakasta matkatavaroiden kanssa ja ilmoitat seuraavalle asiakkaalle mahdollisesta viiveestä."
        },
        {
          "letter": "C",
          "text": "Jätät matkatavarat turvallisen paikan ulkopuolelle ja jatkat matkaa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 212,
      "text": "Miten toimit, kun asiakas jää pois autosta moottoritien varrella?",
      "options": [
        {
          "letter": "A",
          "text": "Asiakas voi jäädä pois autosta moottoritien varrella, jos pyytää sinua pysähtymään."
        },
        {
          "letter": "B",
          "text": "Etsit ensimmäisen turvallisen paikan, josta asiakas voi jäädä pois."
        },
        {
          "letter": "C",
          "text": "Voit pysäköidä hetkeksi moottoritien varrelle, jos hätävilkut ovat päällä."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 213,
      "text": "Mikä seuraavista on turvallisuustekijä, kun autossa kuljetetaan lemmikkieläimiä?",
      "options": [
        {
          "letter": "A",
          "text": "Lemmikkieläimet voivat matkustaa taksissa ilman erityisiä toimenpiteitä."
        },
        {
          "letter": "B",
          "text": "Lemmikkieläimet tulee sijoittaa ajoneuvon takakonttiin tai käyttää niille tarkoitettua matkustuskoria tai -häkkiä."
        },
        {
          "letter": "C",
          "text": "Lemmikkieläimet voivat istua matkustajan sylissä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Which of the following is a safety factor when transporting pets in a car?\nA: Pets may travel in a taxi without special measures.\nB: Pets must be placed in the boot or in a travel crate or carrier designed for them.\nC: Pets may sit in the passenger's lap.\n\n--- Keywords ---\nlemmikkieläimet = pets\nmatkustuskori = travel crate\nhäkki = carrier\ntakakontti = boot / trunk\nturvallisuus = safety\n\n--- Explanation ---\nPets need a crate or secure placement in the boot — not free roaming or on laps.\n\nCorrect answer: B"
    },
    {
      "id": 221,
      "text": "Mitä teet, jos asiakas on aggressiivinen?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkat matkaa ja toivot, että asiakas rauhoittuu."
        },
        {
          "letter": "B",
          "text": "Pysähdyt turvalliseen paikkaan ja pyydät asiakasta poistumaan."
        },
        {
          "letter": "C",
          "text": "Soitat poliisille ja odotat heidän saapumistaan."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do if a customer is aggressive?\nA: Continue driving and hope the customer calms down.\nB: Stop in a safe place and ask the customer to leave.\nC: Call the police and wait for them to arrive.\n\n--- Keywords ---\naggressiivinen = aggressive\nturvalliseen paikkaan = safe place\nPysähdyt = you stop\npoistumaan = to leave\n\n--- Explanation ---\nStop safely and ask an aggressive passenger to leave the vehicle.\n\nCorrect answer: B"
    },
    {
      "id": 229,
      "text": "Miten varmistat matkustajan turvallisen poistumisen autosta vilkkaalla alueella?",
      "options": [
        {
          "letter": "A",
          "text": "Pysähdy laillisessa ja turvallisessa paikassa."
        },
        {
          "letter": "B",
          "text": "Anna asiakkaan poistua missä tahansa."
        },
        {
          "letter": "C",
          "text": "Pysähdy vain, jos asiakas vaatii."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: How do you ensure the passenger exits safely in a busy area?\nA: Stop in a legal and safe place.\nB: Let the customer get out anywhere.\nC: Stop only if the customer demands it.\n\n--- Keywords ---\nPysähdy = stop\nlaillisessa = legal\nturvallisessa paikassa = safe place\nvilkas alue = busy area\n\n--- Explanation ---\nAlways stop in a legal, safe place for passenger exit — not anywhere the customer wants.\n\nCorrect answer: A"
    },
    {
      "id": 235,
      "text": "Miten toimit, kun asiakas jää pois autosta moottoritien varrella?",
    ...
    },
    {
      ...
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Which of the following is a safety factor when transporting pets in a car?\nA: Pets may travel in a taxi without special measures.\nB: Pets must be placed in the boot or in a travel crate or carrier designed for them.\nC: Pets may sit in the passenger's lap.\n\n--- Keywords ---\nlemmikkieläimet = pets\nmatkustuskori = travel crate\nhäkki = carrier\ntakakontti = boot\nturvallisuus = safety\n\n--- Explanation ---\nSecure pets in a crate or the boot — not loose or on a passenger's lap.\n\nCorrect answer: B"
    },
    {
      "id": 240,
      "text": "Mitä teet, jos asiakas käyttäytyy aggressiivisesti ja uhkaavasti ajon aikana?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkat ajoa ja yrität rauhoitella asiakasta."
        },
        {
          "letter": "B",
          "text": "Pysäytät ajoneuvon turvalliseen paikkaan ja pyydät asiakasta poistumaan."
        },
        {
          "letter": "C",
          "text": "Ohitat asiakkaan käytöksen ja ajat nopeasti määränpäähän."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do if a customer behaves aggressively and threateningly during the trip?\nA: Continue driving and try to calm the customer.\nB: Stop the vehicle in a safe place and ask the customer to leave.\nC: Ignore the behaviour and drive quickly to the destination.\n\n--- Keywords ---\naggressiivisesti = aggressively\nuhkaavasti = threateningly\nturvalliseen paikkaan = safe place\nPysäytät = you stop\npoistumaan = to leave\n\n--- Explanation ---\nStop in a safe place and ask a threatening passenger to leave the vehicle.\n\nCorrect answer: B"
    },
    {
      "id": 242,
      "text": "Mikä on oikea toimintatapa, jos asiakas haluaa avata ikkunoita ajon aikana?",
      "options": [
        {
          "letter": "A",
          "text": "Kieltäydyt aina avaamasta ikkunoita."
        },
        {
          "letter": "B",
          "text": "Sallit ikkunoiden avaamisen, jos se ei vaikuta muiden matkustajien mukavuuteen ja turvallisuuteen."
        },
        {
          "letter": "C",
          "text": "Avaat ikkunat automaattisesti ilman asiakkaan pyyntöä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What is the correct procedure if a customer wants to open windows during the trip?\nA: You always refuse to open windows.\nB: You allow windows to be opened if it does not affect other passengers' comfort and safety.\nC: You open windows automatically without the customer's request.\n\n--- Keywords ---\nikkunat = windows\nmukavuus = comfort\nturvallisuus = safety\nSallit = you allow\nmatkustajat = passengers\n\n--- Explanation ---\nAllow window opening when it does not harm comfort or safety of others.\n\nCorrect answer: B"
    },
    {
      "id": 244,
      "text": "Miten toimitaan, jos asiakas tarvitsee apua turvavyön kiinnittämisessä?",
      "options": [
        {
          "letter": "A",
          "text": "Kerrot asiakkaalle, että hänen tulee kiinnittää turvavyö itse."
        },
        {
          "letter": "B",
          "text": "Autat asiakasta kiinnittämään turvavyön ja varmistat, että se on oikein kiinnitetty."
        },
        {
          "letter": "C",
          "text": "Jätät turvavyön kiinnittämättä, jos asiakas ei osaa tehdä sitä itse."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 246,
      "text": "Miten taksinkuljettaja voi edistää asiakkaiden turvallisuutta yöaikaan?",
      "options": [
        {
          "letter": "A",
          "text": "Käyttämällä reittejä, jotka ovat hyvin valaistuja ja turvallisia."
        },
        {
          "letter": "B",
          "text": "Ajamalla nopeammin, jotta asiakas pääsee nopeammin perille."
        },
        {
          "letter": "C",
          "text": "Pitämällä auton ovet auki ajaessaan."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: How can a taxi driver promote customer safety at night?\nA: By using routes that are well lit and safe.\nB: By driving faster so the customer arrives sooner.\nC: By keeping the car doors open while driving.\n\n--- Keywords ---\nyöaikaan = at night\nvalaistuja = well lit\nturvallisia reittejä = safe routes\nturvallisuus = safety\nasiakkaat = customers\n\n--- Explanation ---\nAt night, choose well-lit, safe routes — do not speed or drive with doors open.\n\nCorrect answer: A"
    },
    {
      "id": 270,
      "text": "Asiakas jätetään hoitolaitoksen luona. Mikä on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Vastuu päättyy, kun asiakas on noussut ulos autosta."
        },
        {
          "letter": "B",
          "text": "Kuljettajan on huolehdittava, että asiakas pääsee tarvittaessa hoitohenkilökunnan luo."
        },
        {
          "letter": "C",
          "text": "Kuljettajan on aina riisuttava asiakkaan ulkovaatteet."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 273,
      "text": "Asiakkaasi saa kouristuskohtauksen taksissa (tiedät hänellä olevan epilepsia). Mikä on ensimmäinen ensiaputoimenpide?",
      "options": [
        {
          "letter": "A",
          "text": "Pidät tiukasti kiinni asiakkaasta."
        },
        {
          "letter": "B",
          "text": "Varmistat, ettei hän loukkaa päätään, etkä estä kouristuksia. Kohtausten vähentyessä käännät hänet kylkiasentoon."
        },
        {
          "letter": "C",
          "text": "Jatkat matkaa normaalisti."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 277,
      "text": "Asiakas on nauttinut alkoholia ja lähtee hoiperrellen kotiovelle pakkasessa (-30 °C). Mitä teet?",
      "options": [
        {
          "letter": "A",
          "text": "Varmistat, että asiakas pääsee sisälle kotiovesta."
        },
        {
          "letter": "B",
          "text": "Asiakas ei ole enää vastuullasi autosta poistuttuaan."
        },
        {
          "letter": "C",
          "text": "Puhallutat asiakkaan ja viet poliisille, jos yli 0,5 ‰."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 292,
      "text": "Mitä teet, jos asiakas pyytää pysähtymään/odottamaan paikassa, jossa pysähtyminen on kielletty?",
      "options": [
        {
          "letter": "A",
          "text": "Asiakkaalla on oikeus valita paikka."
        },
        {
          "letter": "B",
          "text": "Kuljettaja voi poiketa säännöistä syystä."
        },
        {
          "letter": "C",
          "text": "Jäädään odottamaan paikkaan, jossa pysähtyminen on sallittua."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: What do you do if a customer asks to stop/wait where stopping is prohibited?\nA: The customer has the right to choose the place.\nB: The driver may deviate from rules for a reason.\nC: Wait in a place where stopping is allowed.\n\n--- Keywords ---\npysähtyminen kielletty = stopping prohibited\nsallittua = allowed\nodottamaan = to wait\npaikka = place\n\n--- Explanation ---\nDo not stop where prohibited. Wait in a legal stopping place nearby.\n\nCorrect answer: C"
    }
  ],
  "special_needs": [
    {
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "letter": "C",
          "text": "Taksissa asiakkaan turvavyön käyttö on aina vapaaehtoista"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Lasta voi kuljettaa ilman turvalaitetta, kunhan istuu takapenkillä turvavyöhön kytkettynä"
        },
        {
          "letter": "B",
          "text": "Lasta voi kuljettaa täysi-ikäisen matkustajan sylissä takapenkillä"
        },
        {
          "letter": "C",
          "text": "Lapsi tulee kuljettaa aina asianmukaisessa turvalaitteessa"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan on hyvä näkövammaista palvellessa puhua hiukan kovemmalla äänellä."
        },
        {
          "letter": "B",
          "text": "Taksinkuljettaja tulee aina ohjata asiakasta olkapäästä ja auttaa hänet autoon kevyesti työntäen."
        },
        {
          "letter": "C",
          "text": "Taksinkuljettajan on hyvä kysyä asiakkaalta, miten häntä voi auttaa ennen kuin ryhtyy auttamaan asiakasta."
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Keskustelet aina vain avustajan kanssa"
        },
        {
          "letter": "B",
        ...
        {
          "letter": "C",
          "text": "Pyydät kirjalliset ohjeet kuinka tulee toimia"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Totean asiakkaalle, että hän ei saa siirtyä pyörätuolista ajoneuvoon ilman kuljettajan apua"
        },
        {
          "letter": "B",
          "text": "Totean asiakkaalle, että hänellä on oikeus siirtyä itse pyörätuolista ajoneuvoon ja tarvittaessa avustan häntä"
        },
        {
          "letter": "C",
          "text": "Totean asiakkaalle, että pyörätuolissa saapuva asiakas ei saa istua ajoneuvon etupenkillä"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Asiakas ei voi koskaan siirtyä ilman kuljettajan apua."
        },
        {
          "letter": "B",
          "text": "Annat asiakkaan siirtyä itse ja avustat tarvittaessa."
        },
        {
          "letter": "C",
          "text": "Jos matkustaja haluaa siirtyä itse ajoneuvoon, voit siirtyä odottamaan kuljettajan paikalle."
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Valitettavasti laki kieltää minua hakemasta alkoholia asiakkaille."
        },
        {
          "letter": "B",
          "text": "Totta kai voin hakea ne. Mutta älä ihmettele, jos Alkon myyjä tulee tarkistamaan autoon, kenelle juomat tulevat. Joudun kertomaan henkilökunnalle, että en osta alkoholijuomia itselleni, vaan taksissa odottavalle asiakkaalle."
        },
        {
          "letter": "C",
          "text": "Totta kai voin hakea, mutta sinun täytyy kirjoittaa minulle kirjallinen valtakirja, jossa valtuutat minut hakemaan itsellesi juomat."
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "letter": "C",
          "text": "Tarkastaa nostin silmämääräisesti"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "12 ikävuoteen asti"
        },
        {
          "letter": "B",
          "text": "15 ikävuoteen asti"
        },
        {
          "letter": "C",
          "text": "18 ikävuoteen asti"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Varmista, että asiakas pääsee turvallisesti ulos autosta."
        },
        {
          "letter": "B",
          "text": "Anna asiakkaan selviytyä itse."
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Työnnät pyörätuolia aina etuperin."
        },
        {
          "letter": "B",
          "text": "Pyydät asiakasta siirtymään itse pyörätuolista autoon."
        },
        {
          "letter": "C",
          "text": "Autat asiakasta siirtymään pyörätuolista autoon ja varmistat, että pyörätuoli on turvallisesti kiinnitetty ajoneuvoon."
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Pyörätuoli on kiinnitettävä rungosta."
        },
        {
          "letter": "B",
          "text": "Sisäkäyttöön tarkoitettua pyörätuolia ei tarvitse kiinnittää, jos matka < 1 km."
        },
        {
          "letter": "C",
          "text": "Asiakas päättää itse kiinnitetäänkö pyörätuoli."
        }
      ],
      "correct": "A",
  ...
  "customer_service": [
    {
      "id": 8,
      "text": "Mikä seuraavista hyvää viestimien käyttöön liittyvää asiakaspalvelua?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja voi lähettää viestejä, jos puhelin on äänettömällä"
        },
        {
          "letter": "B",
          "text": "Puhelun soittaminen, jos se kuljetuksen suorittamiseksi on välttämätön"
        },
        {
          "letter": "C",
          "text": "Kuljettaja voi puhua henkilökohtaisia puheluita, jos asiakas"
        }
      ],
      "correct": "B",
    ...
    {
      "id": 20,
      "text": "Mikä seuraavista on oikein liittyen puhelimen handsfree-laitteeseen?",
      "options": [
        {
          "letter": "A",
          "text": "Handsfree-laitetta ei tarvitse käyttää ajoneuvon liikkuessa, jos puhelu kestää alle"
        },
        {
          "letter": "B",
          "text": "Kuljettaja saa ajoneuvon liikkuessa puhua puhelimeen handsfree-laitetta käyttäen, jos se on kuljetuksen suorittamiseksi välttämätöntä"
        },
        {
          "letter": "C",
          "text": "Jos taksissa ei ole asiakkaita, kuljettaja saa ajoneuvon liikkuessa puhua puhelimeen ilman handsfree-laitetta"
        }
      ],
      "correct": "B",
    ...
    {
      "id": 21,
      "text": "Miten toimit kun kyydissä oleva asiakas pyytää ajamaan ylinopeutta?",
      "options": [
        {
          "letter": "A",
    ...
    {
      "id": 44,
      "text": "Kuinka tulee toimia tilanteessa, jossa kyydin päätyttyä huomaat asiakkaan unohtaneen ajoneuvoon käsilaukkunsa?",
      "options": [
        {
          "letter": "A",
          "text": "Toimitat käsilaukun kuukauden kuluessa poliisin löytötavaratoimistoon."
        },
        {
          "letter": "B",
          "text": "Voit jäädä odottamaan asiakkaan yhteydenottoa ja säilyttää käsilaukkua ajoneuvossa."
        },
        {
          "letter": "C",
          "text": "Toimitat käsilaukun mahdollisimman pian tilausvälitysyrityksen toimistolle."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 45,
      "text": "Kuinka kuljettaja pystyy vaikuttamaan asiakkaan kokemaan matkustusmukavuuteen matkan ajan?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan tulee ylläpitää jatkuvaa keskustelua asiakkaan kanssa."
        },
        {
          "letter": "B",
          "text": "Kuljettajan tulee olla huomaamaton ja äänetön koko matkan ajan."
        },
        {
          "letter": "C",
          "text": "Kuljettajalla tulee olla hyvä tilannetaju asiakkaan tarpeista."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 47,
      "text": "Mikä seuraavista on hyvää asiakaspalvelua?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja tervehtii kohteliaasti ja on valmis puhumaan vain reittiin liittyvistä"
        },
        {
          "letter": "B",
          "text": "Kuljettaja tervehtii kohteliaasti ja arvioi haluaako asiakas keskustella ja antaa asiakkaan päättää aiheesta."
        },
        {
          "letter": "C",
          "text": "Tervehtii kohteliaasti ja aloittaa keskustelun itselleen mieluisesta aiheesta."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 59,
      "text": "Paljonko siivouslisämaksua asiakas joutuu maksamaan, jos sotkee auton?",
      "options": [
        {
          "letter": "A",
          "text": "550 €"
    ...
    {
      "id": 73,
      "text": "Mikä on oikea tapa toimia tilanteessa, kun kyydissä olevalla matkustajalla on kiire ja liikenne on ruuhkautunut?",
      "options": [
        {
          "letter": "A",
          "text": "Pidät asiakkaan tilanteen tasalla ja kerrot mahdollisesta myöhästymisestä."
        },
        {
          "letter": "B",
          "text": "Aikataulun kiinniottamiseksi voit ajaa loppumatkan ylinopeudella."
        },
        {
          "letter": "C",
          "text": "Asiakkaan kiireen vuoksi voit rikkoa liikennesääntöjä, jotta pysytte aikataulussa."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 74,
      "text": "Mitä seuraavassa kolme väittämää koskien taksinkuljettajan velvollisuuksia. Mikä niistä on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan tulee huolehtia, että alle 3-vuotias lapsi istuu etupenkillä, kun hänellä on käytössä turvalaite."
        },
        {
          "letter": "B",
          "text": "Kuljettajan tulee huolehtia, että alle 135 cm:n pituinen lapsi tarvitsee aina hyväksytyn turvalaitteen matkustaessaan taksissa."
        },
        {
          "letter": "C",
          "text": "Kuljettajan tulee huolehtia, että yli 3-vuotias lapsi matkustaa ilman turvalaitetta, kun hän istuu takapenkillä ja on turvavöissä."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 83,
      "text": "Mikä seuraavista on oikein liittyen taksipalveluun?",
      "options": [
        {
          "letter": "A",
          "text": "Kuitin tarjoaminen asiakkaalle on vaihtoehtoista."
        },
        {
          "letter": "B",
          "text": "Kuitin tarjoaminen asiakkaalle on pakollista."
        },
        {
          "letter": "C",
          "text": "Kuitin tarjoaminen asiakkaalle on lisämaksullinen palvelu."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 87,
      "text": "Kuinka tulee toimia tilanteessa, jossa kyydin päätyttyä huomaat asiakkaan unohtaneen ajoneuvoon käsilaukkunsa? (see 44)",
      "options": [
        {
          "letter": "A",
          "text": "Voit jäädä odottamaan asiakkaan yhteydenottoa ja säilyttää käsilaukkua ajoneuvossa."
        ...
        {
          "letter": "B",
          "text": "Toimitat käsilaukun mahdollisimman pian tilausvälitysyhtiön toimistolle."
        },
        {
          "letter": "C",
          "text": "Toimitat käsilaukun viipymättä asiakkaalle tai poliisin löytötavaratoimistoon."
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Kyyti suuntautuu toiselle liikennealueelle."
        },
        {
          "letter": "B",
          "text": "Laillinen työaika ylittyisi."
        },
        {
          "letter": "C",
          "text": "Asiakas on menossa toiselle kunnan alueelle."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 102,
      "text": "Miten kuljettajan tulee valita käytettävä ajoreitti kohteeseen, jos matkustaja jättää valinnan kuljettajalle ja kun matkan hinta perustuu matkan pituuteen tai matkaan käytettävään aikaan?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan ei tarvitse valita reittiä, koska asiakkaan tulee tietää reitti perille."
        },
        {
          "letter": "B",
          "text": "Kuljettajan tulee valita matkustajan kannalta edullisin tarkoituksenmukainen reitti."
        },
        {
          "letter": "C",
          "text": "Kuljettaja voi valita minkä reitin hyvänsä."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 111,
      "text": "Asiakas tulee kyytiin taksiasemalta ja ilmoittaa haluavansa osoitteeseen, joka ei ole sinulle tuttu ennestään. Kuinka toimit?",
      "options": [
        {
          "letter": "A",
          "text": "Näppäilet osoitteen navigaattorille ja seuraat sen antamia neuvoja."
        },
        {
          "letter": "B",
          "text": "Kerrot asiakkaalle, että osoite ei valitettavasti ole sinulle ennestään tuttu, ja tiedustelet samalla hieman lisätietoja osoitteesta."
        },
        {
          "letter": "C",
          "text": "Lähdet ajamaan siihen suuntaan, missä epäilet osoitteen sijaitsevan."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 112,
      "text": "Mitä tarkoittaa taksinkuljettajalla vaadittava riittävä kielitaito?",
      "options": [
        {
          "letter": "A",
          "text": "Se tarkoittaa sitä, että kuljettajan on pitänyt suorittaa kansalaisuuden kielikoe."
        },
        {
          "letter": "B",
          "text": "Se tarkoittaa sitä, että kuljettaja kykenee kommunikoimaan asiakkaan kanssa siten, että asiakas pääsee turvallisesti oikeaan määränpäähänsä."
        },
        {
          "letter": "C",
          "text": "Se tarkoittaa sitä, että kuljettaja pystyy keskustelemaan asiakkaan kanssa sujuvasti päivän tapahtumista."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 115,
      "text": "Saat suuryrityksestä kyytiisi kiireisen toimitusjohtajan. Hän juoksee taksille ja huikkaa jo matkalla, että hänellä on hirvittävä kiire, sillä tärkeä kokous alkaa jo 15 minuutin kuluttua. On iltapäivän ruuhkaaika ja matka on sen verran pitkä, että tiedät joetukäteen, ettei sitä pysty millään ajamaan siinä ajassa. Kerrot tästä asiakkaalle, jolloin hän vaatii sinua ajamaan ylinopeutta. Asiakas lupautuu maksamaan mahdolliset ylinopeussakot. Kuinka toimit?",
      "options": [
        {
          "letter": "A",
          "text": "Toteat, että sopimus kuulostaa reilulta ja lähdet ajamaan kohti määränpäätä niin nopeasti kuin pääsee."
        },
        {
          "letter": "B",
          "text": "Kerrot asiakkaalle, ettet voi ajaa ylinopeutta, mutta teet parhaasi jotta hän pääsee turvallisesti perille nopeinta mahdollista reittiä."
        },
        {
          "letter": "C",
          "text": "Toteat asiakkaalle, että et voi ottaa häntä lainkaan kyytiin ja kutsut poliisin paikalle, sillä asiakas yllytti sinua rikokseen."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: A hurried CEO from a large company jumps into your taxi and shouts that they are in a terrible hurry — an important meeting starts in 15 minutes. It is afternoon rush hour and the trip is too long to make it in time. You explain this; the customer demands speeding and offers to pay any fines. How do you act?\nA: You say the deal sounds fair and drive toward the destination as fast as possible.\nB: You tell the customer you cannot speed, but you do your best to get them there safely via the fastest possible route.\nC: You tell the customer you cannot take them at all and call the police because they incited you to commit a crime.\n\n--- Keywords ---\nKerrot asiakkaalle = you tell the customer\nylinopeus = speeding\nreittiä = route\nturvallisesti = safely\nkiire = hurry\n\n--- Explanation ---\nNever speed for a customer. Drive the fastest legal route and explain you cannot exceed limits.\n\nCorrect answer: B"
    },
    {
      "id": 123,
    ...
    {
      "id": 127,
      "text": "Millä maksuvälineillä asiakkaalla on oikeus maksaa taksimatkansa, jos hän tulee taksiasemalta ilman etukäteen tehtyä tilausta?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan tehtävänä on päättää käytettävä maksuväline."
        },
        {
          "letter": "B",
          "text": "Asiakkaalla on oikeus maksaa matkansa käteisellä ja yleisimmillä maksukorteilla."
        },
        {
          "letter": "C",
          "text": "Asiakas voi maksaa taksimatkansa ainoastaan käteisellä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: With which payment methods may a customer pay for a taxi trip if they come from a taxi stand without a prior booking?\nA: It is the driver's task to decide the payment method.\nB: The customer has the right to pay with cash and the most common payment cards.\nC: The customer may pay only with cash.\n\n--- Keywords ---\nkäteisellä = with cash\nmaksukortit = payment cards\nmaksuväline = payment method\ntaksiasema = taxi stand\noikeus = right\n\n--- Explanation ---\nCustomers may pay with cash and common payment cards — not cash only.\n\nCorrect answer: B"
    },
    {
      "id": 131,
      "text": "Mitä taksinkuljettajana voit tehdä, kun kyydissä olevalla asiakkaalla on kiire ja liikenne on ruuhkaa?",
      "options": [
        {
          "letter": "A",
          "text": "En välitä, koska en voi asialle mitään."
        },
        {
          "letter": "B",
          "text": "Kerrot asiakkaalle tilanteen ja pidät hänet ajan tasalla."
        },
        {
          "letter": "C",
          "text": "Ajat ylinopeutta ja jos asiakas maksaa sakot."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What can you do as a taxi driver when a passenger is in a hurry and traffic is congested?\nA: I do not care, because I cannot do anything about it.\nB: You tell the customer the situation and keep them informed.\nC: You drive over the speed limit if the customer pays the fines.\n\n--- Keywords ---\nKerrot asiakkaalle = you tell the customer\najan tasalla = informed / up to date\nruuhka = congestion / rush\nkiire = hurry\n\n--- Explanation ---\nKeep the customer informed about delays. Never speed even if they are in a hurry.\n\nCorrect answer: B"
    },
    {
      "id": 132,
    ...
    {
      "id": 133,
      "text": "Saako taksinkuljettaja käyttää puhelinta ajon aikana siten, että pitää puhelimen kädessä?",
      "options": [
        {
          "letter": "A",
          "text": "Saa"
        ...
        {
          "letter": "C",
          "text": "Saa, jos ei ole asiakas kyydissä."
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "letter": "B",
          "text": "Kuitin tarjoaminen asiakkaalle on vapaaehtoista."
        },
        {
          "letter": "C",
          "text": "Kuitin tarjoaminen asiakkaalle on pakollista."
    ...
    {
      "id": 143,
      "text": "Onko asiakkaalla oikeus valittaa taksimatkan aikana kokemastaan huonosta palvelusta?",
      "options": [
        {
          "letter": "A",
          "text": "Taksin valitessaan asiakas sitoutuu tiettyyn palveluun, jolloin hänellä ei ole oikeutta valittaa."
        },
        {
          "letter": "B",
          "text": "Asiakkaita kohtaan tulee aina käyttäytyä kohteliaasti ja asiallisesti, joten palvelun tasosta voi tehdä valituksen."
        },
        {
          "letter": "C",
          "text": "Taksinkuljettajan toimintaa asiakaspalvelutilanteessa ei säädellä millään tavalla, joten palvelusta ei voi valittaa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 158,
      "text": "Paljonko ohjeisen hinnaston mukaan on sunnuntaina ajettavan yhden henkilön  kyydin kokonaishinta, kun matkan pituus on 20 km ja matka-aika on 30 minuuttia, eikä  kiinteää hintaa sovita? [laadittu kuvan perusteella]",
      "options": [
        {
          "letter": "A",
          "text": "65,00 €"
    ...
    {
      "id": 161,
      "text": "Miten toimit, kun asiakas pyytää ajamaan ylinopeutta?",
      "options": [
        {
          "letter": "A",
          "text": "Voit ajaa ylinopeutta, jos asiakas on sovittu,että hän maksaa ylinopeussakot."
        },
        {
          "letter": "B",
          "text": "Kerrot asiakkaalle ettet voi ajaa ylinopeutta, mutta teet parhaasi, jotta hän pääsee turvallisesti perillä, nopein mahdollista reittiä."
        },
        {
          "letter": "C",
          "text": "Voit ajaa ylinopeus, jos asiakkaalla on siihen perusteltu syy"
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do when a customer asks you to drive over the speed limit?\nA: You may speed if the customer agrees to pay speeding fines.\nB: You tell the customer you cannot speed, but do your best to get them there safely via the fastest route.\nC: You may speed if the customer has a justified reason for it\n\n--- Keywords ---\nylinopeus = speeding\nKerrot asiakkaalle = you tell the customer\nturvallisesti = safely\nnopein mahdollinen reitti = fastest possible route\n\n--- Explanation ---\nNever speed for a customer. Drive the fastest legal route and explain you cannot exceed limits.\n\nCorrect answer: B"
    },
    {
      "id": 164,
      "text": "Mikä seuraavista väittämistä pidä paikkaansa.",
      "options": [
        {
          "letter": "A",
          "text": "jos kuljettaja joutuu auton liikkuessa soittamaan puhelun, hänen ei tarvitse käyttää handfree laitetta."
        },
        {
          "letter": "B",
          "text": "Mikäli taksissa ei ole asiakkaita, saa kuljettaja ajoneuvon liikkuessa katsella televisiokuvaa Integroidusta näytöstä."
        },
        {
          "letter": "C",
          "text": "Kuljettaja saa soittaa puhelun ajon aikana handfree-laitetta käyttäen, jos se on kuljetuksen suorittamiseksi välttämätön."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 183,
      "text": "Taksinkuljettajan Reinikaisella on huono päivä ja hänestä tuntuu, mikään ei ole mennyt päivän aikana kovinkaan hyvin. hänen ei tee mieli hymyillä eikä varsinkaan puhua asiakkaiden kanssa. Asiakkaiden mielipiteet ärsyttävät ja eräälle asiakkaalle hän on erityisen töykeä. asiakas tekee tilanteesta valituksen. Onko asiakkaalla oikeus valittaa saamasta palvelusta?",
      "options": [
        {
          "letter": "A",
          "text": "Kyllä, sillä asiakkaita kohtaan tulee aina käyttäytyä kohteliaasti asiallisesti."
        },
        {
          "letter": "B",
          "text": "Ei, sillä asiakas ei osta taksiin tullessaan iloista palvelua vaan kuljetuksen määränpäähän"
        },
        {
          "letter": "C",
          "text": "Ei, sillä kyseinen tapa on Reinikaisen tapa toimia, eikä häntä siitä voi moittia"
        }
      ],
      "correct": "A",
    ...
    {
      "id": 184,
      "text": "Mikä seuraavista hyvää asiakaspalvelua?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja tervehtii kohteliaasti ja tunnustelee onko asiakas halukas jutustelemaan ja antaa päättää aiheesta."
        },
        {
          "letter": "B",
          "text": "Kuljettaja tervehtii kohteliaasti ja suostuu keskustelemaan ainoastaan ajoreitin liittyvistä asioista."
        },
        {
          "letter": "C",
          "text": "Kuljettaja tervehtii kohteliaasti ja aloittaa keskustelun itselleen mieleistä aiheesta."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 187,
      "text": "kuljettaja pystyy vaikuttamaan merkittävästi asiakkaan matkustusmukavuuteen mitä sinulta odotetaan?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkuva keskustelu ylläpitoa."
        },
        {
          "letter": "B",
          "text": "Hyvää pelisilmää, sillä joskus asiakkaat eivät haluaa keskustella ja taas asiakas haluaa juttukumppanin."
        },
        {
          "letter": "C",
          "text": "Huomaamatonta ja äänetöntä olemusta."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: The driver significantly affects passenger comfort. What is expected of you?\nA: Maintaining continuous conversation.\nB: Good situational awareness — some customers want silence, others want company.\nC: Being unnoticeable and silent.\n\n--- Keywords ---\nmatkustusmukavuus = travel comfort\npelisilmä = situational awareness\nkeskustelu = conversation\nasiakas = customer\n\n--- Explanation ---\nRead the customer's mood — some want to talk, others prefer quiet.\n\nCorrect answer: B"
    },
    {
      "id": 188,
      "text": "Kalle kuljettaja on ajanut opintojensa ohella Ismo isännälle neljä vuoden ajan. nyt hän on valmistanut opinnoissaan ja aikoo muuttaa toiselle paikkakunnalle, joten hän päättää työsuhteensa Ismo isäntään. kuinka on kallen irtisanomisaika?",
      "options": [
        {
          "letter": "A",
          "text": "14 päivää, sillä työsuhde on kestänyt alle viisi vuotta."
        },
        {
          "letter": "B",
          "text": "1 kuukausi, sillä työsuhde on yli vuoden, mutta alle viisi vuotta."
        },
        {
          "letter": "C",
    ...
    {
      "id": 190,
      "text": "Milloin tarvitsee asiakkaalle tarjota kuitti taksikyydistä?",
      "options": [
        {
          "letter": "A",
          "text": "Jos kyyti on tilattu applikaatiolla"
        },
        {
          "letter": "B",
          "text": "Jos taksin hinta on kiintiö"
        },
        {
          "letter": "C",
          "text": "Kyydistä on annettava kuitti"
        }
      ],
      "correct": "C",
    ...
    {
      "id": 191,
      "text": "Mikä seuraavista väittämistä taksinkuljettajan velvollisuuksista on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Alle 135 cm pituinen lapsi tarvitsee aina turvalaitteen matkustaessaan taksissa."
        },
        {
          "letter": "B",
          "text": "Lapsi voi matkustaa taksissa ilman turvalaitetta, kunhan istuu takapenkillä ja on turvavöissä."
    ...
    {
      "id": 192,
      "text": "Mikä seuraavista on hyvää asiakaspalvelua viestimien käytössä?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja voi lähettää viestejä, jos puhelin on äänettömällä."
        ...
        {
          "letter": "B",
          "text": "Kuljettaja ei käytä viestimiä ajon aikana."
        },
        {
          "letter": "C",
          "text": "Kuljettaja voi käyttää viestimiä vain pysähtyneenä."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: Which of the following is good customer service regarding use of communication devices?\nA: The driver may send messages if the phone is on silent.\nB: The driver does not use communication devices during driving.\nC: The driver may use communication devices only when stopped.\n\n--- Keywords ---\nviestimet = communication devices\npysähtyneenä = when stopped\najon aikana = during driving\nasiakaspalvelu = customer service\n\n--- Explanation ---\nCommunication devices may be used only when the vehicle is stopped.\n\nCorrect answer: C"
    },
    {
      "id": 193,
      "text": "Miten toimit, kun asiakkaalla on käteisellä maksamisen vaikeuksia?",
      "options": [
        {
          "letter": "A",
          "text": "Ehdotat asiakkaalle, että hän hakee rahaa läheiseltä pankkiautomaatilta."
        },
        {
          "letter": "B",
          "text": "Ehdotat asiakkaalle, että hän maksaa yleisimmällä maksukortilla."
        },
        {
          "letter": "C",
          "text": "Matka perutaan, jos asiakkaalla ei ole käteistä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do when a customer has difficulty paying with cash?\nA: You suggest they get money from a nearby ATM.\nB: You suggest they pay with a common payment card.\nC: The trip is cancelled if the customer has no cash.\n\n--- Keywords ---\nmaksukortti = payment card\nkäteinen = cash\nEhdotat = you suggest\nmaksaminen = payment\n\n--- Explanation ---\nOffer card payment as an alternative when cash is a problem.\n\nCorrect answer: B"
    },
    {
      "id": 194,
      "text": "Mitä tarkoittaa riittävä kielitaito taksinkuljettajalle?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja osaa keskustella asiakkaan kanssa päivän tapahtumista sujuvasti."
        },
        {
          "letter": "B",
          "text": "Kuljettaja osaa palvella asiakasta ja hoitaa työtehtävänsä tarvittavalla kielellä."
        },
        {
          "letter": "C",
          "text": "Kuljettajan pitää pystyä keskustelemaan asiakkaan kanssa vähintään yhdellä vieraalla kielellä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What does sufficient language skill mean for a taxi driver?\nA: The driver can chat fluently with the customer about daily events.\nB: The driver can serve the customer and perform job tasks in the required language.\nC: The driver must converse with the customer in at least one foreign language.\n\n--- Keywords ---\nkielitaito = language skill\npalvella = to serve\ntyötehtävät = job tasks\nriittävä = sufficient\n\n--- Explanation ---\nSufficient language skill means enough to serve customers and do the job — not fluent small talk or a foreign language requirement.\n\nCorrect answer: B"
    },
    {
      "id": 196,
      "text": "Milloin asiakkaalle tulee tarjota kuitti taksikyydistä?",
      "options": [
        {
          "letter": "A",
          "text": "Jos kyyti on tilattu applikaatiolla."
        ...
        {
          "letter": "B",
          "text": "Jos taksin hinta on kiinteä."
        },
        {
          "letter": "C",
          "text": "Kyydistä on aina annettava kuitti."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 199,
      "text": "Mitä teet, kun huomaat asiakkaan unohtaneen tavaransa taksiin?",
      "options": [
        {
          "letter": "A",
          "text": "Yrität mahdollisuuksien mukaan palauttaa tavaran asiakkaalle."
        },
        {
          "letter": "B",
          "text": "Viet tavaran löytötavaratoimistoon."
        },
        {
          "letter": "C",
          "text": "Säilytät tavaran taksissa, kunnes asiakas ottaa yhteyttä."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: What do you do when you notice a customer has left belongings in the taxi?\nA: You try to return the item to the customer as far as possible.\nB: You take the item to the lost-property office.\nC: You keep the item in the taxi until the customer contacts you.\n\n--- Keywords ---\npalauttaa = to return\ntavara = item / belongings\nlöytötavaratoimisto = lost-property office\nasiakas = customer\n\n--- Explanation ---\nTry to return forgotten items to the customer first.\n\nCorrect answer: A"
    },
    {
      "id": 201,
      "text": "Mikä seuraavista on oikein, kun kuljettaja käyttää viestimiä ajon aikana?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja saa käyttää viestimiä ajon aikana, jos se on välttämätöntä."
        },
        {
          "letter": "B",
          "text": "Kuljettaja saa käyttää viestimiä ajon aikana handsfree-laitetta käyttäen."
        },
        {
          "letter": "C",
          "text": "Kuljettaja ei saa käyttää viestimiä ajon aikana."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 203,
      "text": "Miten käsittelet tilanteen, jos asiakkaasi ei pysty maksamaan matkaa?",
      "options": [
        {
          "letter": "A",
          "text": "Aja asiakkaan kotiin ja pyydä häntä maksamaan myöhemmin."
        },
        {
          "letter": "B",
          "text": "Pyydä asiakasta lähtemään autosta ilman maksua."
        },
        {
          "letter": "C",
          "text": "Selvitä tilanne rauhallisesti ja mahdollisuuksien mukaan käytä maksamattomasta matkasta ilmoitusta työnantajalle tai viranomaisille."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 205,
      "text": "Miten toimit, jos asiakas haluaa, että ajat ylinopeutta ehtiäksesi kiireelliseen tapaamiseen?",
      "options": [
        {
          "letter": "A",
          "text": "Suostut pyyntöön, jos asiakkaalla on kiire."
        },
        {
          "letter": "B",
          "text": "Kieltäydyt pyyntöön kohteliaasti ja selität, että ajoneuvon nopeusrajoituksia on noudatettava turvallisuuden ja lain mukaisesti."
        },
        {
          "letter": "C",
          "text": "Kiihdytät hieman mutta yrität välttää liikaa ylinopeutta."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 214,
      "text": "Miten taksinkuljettajan tulee toimia, jos asiakas kertoo osoitteen, joka ei ole hänelle ennestään tuttu?",
      "options": [
        {
          "letter": "A",
          "text": "Lähdet ajamaan siihen suuntaan, missä epäilet osoitteen sijaitsevan."
        ...
        {
          "letter": "B",
          "text": "Näpyttelen osoitteen navigaattoriin ja seuraan sen antamia neuvoja."
        },
        {
          "letter": "C",
          "text": "Kerron asiakkaalle, että osoite ei valitettavasti ole minulle ennestään tuttu, ja tiedustelen lisätietoja osoitteesta."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 217,
      "text": "Mikä seuraavista taksinkuljettajan velvollisuuksista on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Alle 135 cm pituinen lapsi tarvitsee aina turvalaitteen."
        },
        {
          "letter": "B",
          "text": "Lapsi voi matkustaa ilman turvalaitetta takapenkillä turvavöissä."
        },
        {
          "letter": "C",
          "text": "Alle 3-vuotias istuu aina etupenkillä."
    ...
    {
      "id": 245,
      "text": "Mitä tulee tehdä, jos asiakas jättää arvotavaroita taksiin?",
      "options": [
        {
          "letter": "A",
          "text": "Säilytät tavarat autossa ja odotat, että asiakas ottaa sinuun yhteyttä."
        },
        {
          "letter": "B",
          "text": "Ilmoitat löydöstäsi työnantajalle tai poliisille ja toimitat tavarat säilytykseen."
        },
        {
          "letter": "C",
          "text": "Myyt tavarat ja pidät rahat itselläsi."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 247,
      "text": "Mitä tulee tehdä, jos asiakas pyytää sinua odottamaan hetken määränpäässä?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkat matkaa ja jätät asiakkaan odottamaan."
        },
        {
          "letter": "B",
          "text": "Pysyt autossa ja pidät ovet lukittuna odottaessasi."
        },
        {
          "letter": "C",
          "text": "Poistut autosta ja jätät sen käynnissä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What should be done if a customer asks you to wait a moment at the destination?\nA: Continue driving and leave the customer waiting.\nB: Stay in the car and keep doors locked while waiting.\nC: Leave the car with the engine running.\n\n--- Keywords ---\nodottamaan = to wait\nmääränpää = destination\nlukittuna = locked\nPysyt autossa = stay in the car\n\n--- Explanation ---\nStay in the vehicle with doors locked while waiting for the customer.\n\nCorrect answer: B"
    },
    {
      "id": 249,
      "text": "Miten toimitaan, jos taksin maksupääte ei toimi ja asiakkaalla ei ole käteistä?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljetat asiakkaan määränpäähän ja sovit maksutavasta myöhemmin."
        },
        {
          "letter": "B",
          "text": "Pahoittelet tilannetta ja ehdotat lähimmän pankkiautomaatin käyttöä."
        },
        {
          "letter": "C",
          "text": "Kieltäydyt kuljettamasta asiakasta."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: How to act if the taxi payment terminal does not work and the customer has no cash?\nA: Drive to the destination and agree payment method later.\nB: Apologise and suggest using the nearest ATM.\nC: Refuse to transport the customer.\n\n--- Keywords ---\nmaksupääte = payment terminal\nkäteistä = cash\npankkiautomaatti = ATM\nPahoittelet = you apologise\nehdotat = you suggest\n\n--- Explanation ---\nApologise and suggest the nearest ATM or another payment option.\n\nCorrect answer: B"
    },
    {
      "id": 250,
      "text": "Miten toimitaan, jos asiakas tarvitsee erityisapua matkatavaroiden kanssa?",
      "options": [
        {
          "letter": "A",
          "text": "Pyydät asiakasta huolehtimaan itse tavaroistaan."
        },
        {
          "letter": "B",
          "text": "Autat asiakasta matkatavaroiden kantamisessa ja sijoittamisessa ajoneuvoon."
        },
        {
          "letter": "C",
          "text": "Kuljetat asiakkaan ilman tavaroita, jos ne ovat liian raskaita."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 253,
      "text": "Mikä on hyvää viestimien käyttöä asiakaspalvelussa?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja voi lähettää viestejä, jos puhelin on äänettömällä."
        ...
        {
          "letter": "B",
          "text": "Puhelun soittaminen, jos se on välttämätön kuljetuksen suorittamiseksi."
        },
        {
          "letter": "C",
          "text": "Kuljettaja voi puhua henkilökohtaisia puheluja asiakkaan kanssa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 260,
      "text": "Olet kyydissä asiakkaan kanssa ja puhelin soi, mutta sinulla ei ole handsfree- laitetta. Mitä teet?",
      "options": [
        {
          "letter": "A",
          "text": "Vastaat normaalisti ja pahoittelet."
        },
        {
          "letter": "B",
          "text": "Pysähdyt tien varteen ja kirjoitat ylös tarvittavat tiedot."
        },
        {
          "letter": "C",
          "text": "Et vastaa, pahoittelet häiriötä asiakkaalle ja soitat takaisin matkan jälkeen."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 278,
      "text": "Asiakas on unohtanut käsilaukun autoon. Mitä teet?",
      "options": [
        {
          "letter": "A",
          "text": "Viet sen kotiisi ja odotat asiakkaan soittoa."
        },
        {
          "letter": "B",
          "text": "Toimitat sen tilausvälitysyhtiön toimistoon viikon sisällä."
        },
        {
          "letter": "C",
          "text": "Toimitat sen heti asiakkaalle tai poliisin löytötavaratoimistoon."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: A customer forgot a handbag in the car. What do you do?\nA: Take it home and wait for the customer to call.\nB: Deliver to dispatch office within a week.\nC: Deliver immediately to the customer or police lost-property office.\n\n--- Keywords ---\nkäsilaukku = handbag\nlöytötavaratoimisto = lost-property office\nToimitat = you deliver\nviipymättä = immediately\n\n--- Explanation ---\nReturn forgotten items promptly to the customer or police lost-property office.\n\nCorrect answer: C"
    },
    {
      "id": 279,
      "text": "Miten kuljettaja voi vaikuttaa asiakkaan matkustusmukavuuteen?",
      "options": [
        {
          "letter": "A",
          "text": "Ylläpitää jatkuvaa keskustelua."
        },
        {
          "letter": "B",
          "text": "Hyvä pelisilmä: joskus asiakas ei halua jutella, joskus haluaa."
        },
        {
          "letter": "C",
          "text": "Olla huomaamaton ja äänetön."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: How can the driver affect the customer's travel comfort?\nA: Maintain continuous conversation.\nB: Good situational awareness: sometimes the customer does not want to chat, sometimes they do.\nC: Be unnoticeable and silent.\n\n--- Keywords ---\nmatkustusmukavuus = travel comfort\npelisilmä = situational awareness\nkeskustelu = conversation\nasiakas = customer\n\n--- Explanation ---\nRead the customer's mood — some want conversation, others prefer quiet.\n\nCorrect answer: B"
    },
    {
      "id": 285,
      "text": "Mikä seuraavista väittämistä on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Alle 135 cm lapsi tarvitsee aina turvalaitteen."
        },
        {
          "letter": "B",
          "text": "Lapsi voi matkustaa ilman turvalaitetta takapenkillä."
        },
        {
          "letter": "C",
          "text": "Alle 3-vuotias ei saa matkustaa ilman huoltajan kirjallista lupaa."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 286,
      "text": "Jos matkustaja jättää reitin valinnan kuljettajalle, mikä on oikein (matkan hinta perustuu aikaan/pituuteen)?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan ei tarvitse valita reittiä."
        },
        {
          "letter": "B",
          "text": "Kuljettaja voi valita minkä tahansa reitin."
        },
        {
          "letter": "C",
          "text": "Kuljettajan tulee valita asiakkaalle edullisin ja tarkoituksenmukainen reitti."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 294,
      "text": "Asiakas haluaa osoitteeseen, jota et tunne. Miten toimit?",
      "options": [
        {
          "letter": "A",
          "text": "Lähdet ajamaan siihen suuntaan, missä arvelet osoitteen olevan."
        },
        {
          "letter": "B",
          "text": "Laitat osoitteen navigaattoriin ja seuraat ohjeita."
        },
        {
          "letter": "C",
          "text": "Sanot asiakkaalle, ettet tunne osoitetta, ja pyydät lisätietoja."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: A customer wants an address you do not know. How do you act?\nA: Start driving in the direction you guess the address is.\nB: Enter the address in the navigator and follow instructions.\nC: Tell the customer you do not know the address and ask for more details.\n\n--- Keywords ---\nnavigaattori = navigator\nosoite = address\nlisätietoja = more details\ntunne = know\n\n--- Explanation ---\nUse the navigator with the address the customer provides.\n\nCorrect answer: B"
    },
    {
      "id": 295,
      "text": "Mitä tarkoittaa taksinkuljettajalta vaadittava riittävä kielitaito?",
      "options": [
        {
          "letter": "A",
          "text": "Pystyy keskustelemaan asiakkaan kanssa päivän tapahtumista."
        },
        {
          "letter": "B",
          "text": "Pitää olla suorittanut kansalaisuuden kielikoe."
        },
        {
          "letter": "C",
          "text": "Pystyy kommunikoimaan niin, että asiakas pääsee turvallisesti määränpäähänsä."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 297,
      "text": "Asiakas kiirehtii sinua ajamaan ylinopeutta, lupaa maksaa sakot. Miten toimit?",
      "options": [
        {
          "letter": "A",
          "text": "Kerrot ettet voi ajaa ylinopeutta, mutta viet hänet turvallisesti nopeinta reittiä."
        },
        {
          "letter": "B",
          "text": "Hyväksyt sopimuksen ja ajat kovempaa."
        },
        {
          "letter": "C",
          "text": "Kieltäydyt kokonaan ja kutsut poliisin."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: A customer urges you to speed and offers to pay fines. How do you act?\nA: You say you cannot speed but take them safely via the fastest route.\nB: You accept and drive faster.\nC: You refuse entirely and call the police.\n\n--- Keywords ---\nylinopeus = speeding\nturvallisesti = safely\nnopeinta reittiä = fastest route\nsakot = fines\n\n--- Explanation ---\nNever speed for a customer. Drive the fastest legal route and explain you cannot exceed limits.\n\nCorrect answer: A"
    },
    {
      "id": 303,
      "text": "Mitä teet, jos asiakas sanoo, ettei halua keskustella?",
      "options": [
        {
          "letter": "A",
          "text": "Annat asiakkaan olla rauhassa ja puhut vain reittiin liittyvistä asioista."
        },
        {
          "letter": "B",
          "text": "Näytät, että et osaa olla vuorovaikutuksessa."
        },
        {
          "letter": "C",
          "text": "Yrität keskustella koko matkan ajan."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: What do you do if a customer says they do not want to talk?\nA: You let the customer be at peace and speak only about route-related matters.\nB: You show that you cannot interact.\nC: You try to converse throughout the entire trip.\n\n--- Keywords ---\nAnnat asiakkaan olla rauhassa = let the customer be at peace\nreittiin liittyvistä = related to the route\nkeskustella = to talk / converse\nasiakas = customer\n\n--- Explanation ---\nRespect the customer's wish for quiet. Only discuss what is needed for the route.\n\nCorrect answer: A"
    },
    {
      "id": 307,
      "text": "Millä maksuvälineillä asiakas saa maksaa taksimatkansa taksiasemalta otetussa kyydissä?",
      "options": [
        {
          "letter": "A",
          "text": "Vain käteisellä."
        },
        {
          "letter": "B",
          "text": "Kuljettaja päättää."
        },
        {
          "letter": "C",
          "text": "Käteisellä ja yleisimmillä maksukorteilla."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: With which payment methods may a customer pay for a taxi trip taken from a taxi stand?\nA: Cash only.\nB: The driver decides.\nC: Cash and the most common payment cards.\n\n--- Keywords ---\nkäteisellä = with cash\nmaksukortit = payment cards\nmaksuväline = payment method\ntaksiasema = taxi stand\noikeus = right\n\n--- Explanation ---\nCustomers may pay with cash and common payment cards — not cash only.\n\nCorrect answer: C"
    },
    {
      "id": 309,
      "text": "Milloin asiakkaalle pitää antaa kuitti taksimatkasta?",
      "options": [
        {
          "letter": "A",
          "text": "Jos kyyti tilattiin sovelluksella."
        },
        {
          "letter": "B",
          "text": "Jos hinta on kiinteä."
        },
        {
          "letter": "C",
          "text": "Aina kyydistä on annettava kuitti."
        }
      ],
      "correct": "C",
  ...
  "traffic_safety": [
    ...
    {
      "id": 22,
      "text": "Liikenteessä on poikkeusjärjestelyjä liikenneonnettomuuden vuoksi. Saat samaan aikaan keskenään ristiriitaisia toimintaohjeita kolmelta taholta, jotka eivät tiedä toisistaan. Kenellä on seuraavista on määräysvalta eli kenenohjeita sinun tulee noudattaa?",
      "options": [
        {
          "letter": "A",
    ...
    {
      "id": 50,
      "text": "Kenen vastuu on varmistaa, että mukana on liikennelupa?",
      "options": [
        {
          "letter": "A",
          "text": "Taksinkuljettajan"
        ...
        {
          "letter": "B",
          "text": "Taksiliikenneluvan haltija"
        },
        {
          "letter": "C",
    ...
    {
      "id": 56,
      "text": "Ajaessasi taksia, saatko ajaa ajoneuvon kyseisen liikennemerkin vaikutusalueelle?",
      "options": [
        {
          "letter": "A",
          "text": "Aina ajaessani taksia."
        },
        {
          "letter": "B",
          "text": "Vain jos asiakkaalla on painavia matkatavaroita."
        },
        {
          "letter": "C",
          "text": "Aina jos noudan tai tuon asiakkaan."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 82,
      "text": "Missä tilanteessa kuljettajan ei tarvitse käyttää turvavyötä?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan ei tarvitse käyttää turvavyötä yöaikaan ajaessa asiakkaan ollessa kyydissä."
        },
        {
          "letter": "B",
          "text": "Kuljettajan tulee ajaessaan aina käyttää turvavyötä."
        },
        {
          "letter": "C",
          "text": "Kuljettajan ei tarvitse käyttää turvavyötä koulukyyttejä ajaessaan."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 84,
      "text": "Millä tavoin taksinkuljettajan tulee toimia liikenteeä jotta hän täyttää tienkäyttäjän ennakointivelvollisuuden?",
      "options": [
        {
          "letter": "A",
          "text": "Taksinkuljettajan on tienkäyttäjänä ennakoitava toisten tienkäyttäjien toimintaa."
        },
        {
          "letter": "B",
          "text": "Taksinkuljettajan on tienkäyttäjänä käytettävä vain moottorijarrutusta liikenteessä."
        },
        {
          "letter": "C",
          "text": "Taksinkuljettajan on tienkäyttäjänä ammattinsa kautta keskittyttävä vain asiakaspalveluun."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 94,
      "text": "Milloin taksiliikenteessä saa ajaa ilman taksivalaisinta?",
      "options": [
        {
          "letter": "A",
          "text": "Kaikissa ajoissa."
        },
        {
          "letter": "B",
          "text": "Aina silloin, kun ajo alkaa muualta kuin taksiasema-alueelta."
        },
        {
          "letter": "C",
          "text": "Silloin, jos kyseessä on sopimusajo, josta on tehty kirjallinen sopimus."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 95,
      "text": "Olet viemässä asiakasta sairaalasta kotiin. Yhtäkkiä huomaat ulosajaneen auton. Säikähdät tilannetta ja aiot pysähtyä, mutta takapenkillä istuva asiakas vaatii, että viet hänet välittömästi kotiin.",
      "options": [
        {
          "letter": "A",
          "text": "Viet asiakkaan kotiin ja palaat sen jälkeen tapahtumapaikalle."
        },
        {
          "letter": "B",
          "text": "Soitat yleiseen hätänumeroon."
        },
        {
          "letter": "C",
    ...
    {
      "id": 96,
      "text": "Kuinka paljon taksissa saa enintään ylittää ajoneuvon istuinpaikkaluvun mukaisen henkilömäärän, jos kyseessä ei ole koulu- ja päivähoitokuljetus?",
      "options": [
        {
          "letter": "A",
          "text": "Ei yhtään."
        ...
        {
          "letter": "B",
          "text": "Ylitys saa olla enintään 60%."
        },
        {
          "letter": "C",
          "text": "Kuljettajan oman harkinnan mukaan voi päättää, kuinka paljon voi ylittää."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 97,
      "text": "Kuinka pitkään taksinkuljettajan ajolupa on enintään voimassa?",
      "options": [
        {
          "letter": "A",
          "text": "Viisi vuotta"
    ...
    {
      "id": 98,
      "text": "Taksinkuljettajan ajoluvan myöntää:",
      "options": [
        {
          "letter": "A",
          "text": "ELY-keskus liikenne"
        },
        {
          "letter": "B",
          "text": "Viestintävirasto Traficom"
        },
        {
          "letter": "C",
          "text": "Poliisi"
    ...
    {
      "id": 101,
      "text": "Kuinka kauan taksinkuljettajan irtisanomisaika on, kun työsuhde on kestänyt alle viisi vuotta?",
      "options": [
        {
          "letter": "A",
          "text": "7 päivää"
      ...
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: How long is a taxi driver's notice period when the employment has lasted less than five years?\nA: 7 days\nB: 14 days\nC: 1 month\n\n--- Keywords ---\nirtisanomisaika = notice period\nalle viisi vuotta = less than five years\n14 päivää = 14 days\ntyösuhde = employment relationship\ntaksinkuljettaja = taxi driver\n\n--- Explanation ---\nWhen employment has lasted under five years, the notice period is 14 days.\n\nCorrect answer: B"
    },
    {
      "id": 104,
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Vain koulu- ja päivähoitokuljetuksissa."
        },
        {
          "letter": "B",
          "text": "Vain ennakkotilauskuljetuksissa."
        },
        {
          "letter": "C",
          "text": "Kaikissa kuljetuksissa."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 107,
      "text": "Mikä seuraavista on peruste taksinkuljettajan ajoluvan peruuttamiselle?",
      "options": [
        {
          "letter": "A",
          "text": "Alueella toimivat taksinkuljettajat ja taksiyrittäjät suosittelevat ajoluvan peruuttamista."
        },
        {
          "letter": "B",
          "text": "Kuljettaja ei ole työskennellyt viimeisen kolmen vuoden aikana taksinkuljettajana."
        },
        {
          "letter": "C",
          "text": "Kuljettaja on syyllistynyt törkeään liikenneturvallisuuden vaarantamiseen."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 108,
      "text": "Mikä seuraavista kuljettajan työaikaa koskevista väittämistä ei pidä paikkaansa?",
      "options": [
        {
          "letter": "A",
          "text": "Työaikaa on myös kuljettajan työpäivän aikana pitämä kahden tunnin tauko."
        },
        {
          "letter": "B",
          "text": "Taksinkuljettajan vuorokautinen työaika saa olla enimmillään 11 tuntia 24 tunnin"
        },
        {
          "letter": "C",
          "text": "Työaikaa on varsinaisen ajotyön lisäksi taksiasemalla oloaika ja auton siivoaminen."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: Which of the following statements about the driver's working hours is NOT true?\nA: Working time also includes a two-hour break during the driver's workday.\nB: A taxi driver's daily working time may be at most 11 hours in 24 hours\nC: Working time includes, in addition to actual driving, time at the taxi stand and cleaning the car.\n\n--- Keywords ---\nTyöaikaa = working time\nkahden tunnin tauko = two-hour break\nvuorokautinen työaika = daily working time\nei pidä paikkaansa = is not true\n\n--- Explanation ---\nA two-hour break is not counted as working time. The incorrect statement is option A.\n\nCorrect answer: A"
    },
    {
      "id": 109,
      "text": "Mika seuraavista vaittamista on virheellinen?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajalla tulee olla aina mukana taksinkuljettajan ajolupa."
        },
        {
          "letter": "B",
          "text": "Ajoneuvo tulee olla rekisterdity luvanvaraiseen liikenteeseen."
        },
        {
          "letter": "C",
          "text": "Jokaisessa taksissa tulee olla alkolukko."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 110,
      "text": "Kenellä on vastuu työvuorossa käytettävän taksin liikennekelpoisuudesta?",
      "options": [
        {
          "letter": "A",
          "text": "Katsastajalla."
        ...
        {
          "letter": "C",
          "text": "Taksintarkastajalla."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Who is responsible for the roadworthiness of the taxi used during a shift?\nA: The vehicle inspector.\nB: The driver.\nC: The taxi inspector.\n\n--- Keywords ---\nKuljettajalla = the driver\nliikennekelpoisuus = roadworthiness\nvastuu = responsibility\ntyövuoro = shift\n\n--- Explanation ---\nThe driver is responsible for ensuring the taxi is roadworthy during their shift.\n\nCorrect answer: B"
    },
    {
      "id": 113,
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Taitoa toimia oikein vaaratilanteessa onnettomuuden välttämiseksi."
        },
        {
          "letter": "B",
          "text": "Pyrkiä ajamaan niin, että ei joudu vaara- eikä onnettomuustilanteeseen."
        },
        {
          "letter": "C",
          "text": "Osata toimia oikein onnettomuuden sattuessa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 117,
      "text": "Ajat melkein vilkasliikenteistä valtatietä kohti taksiasemaa. Yhtäkkiä huomaat kaukana edellä polkupyöräilijän horjahtavan, kaatuvan ja jäävän maahan makaamaan keskelle tietä liikkumattomana. Mikä on ensimmäinen ensiaputoimenpiteesi?",
      "options": [
        {
          "letter": "A",
          "text": "Polkupyöräilijän siirtäminen turvallisempaan paikkaan."
        },
        {
          "letter": "B",
          "text": "Hengitysteiden avaaminen."
        },
        {
          "letter": "C",
          "text": "Polkupyöräilijän tutkiminen mahdollisten murtumien ja verenvuotojen havaitsemiseksi."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 119,
      "text": "Kuinka kauan rattijuopumukseen syyllistynyt ei voi hakea taksiajolupaa?",
      "options": [
        {
          "letter": "A",
          "text": "Kolmen vuoden ajan."
        },
        {
          "letter": "B",
          "text": "Vuoden ajan."
        ...
        {
          "letter": "C",
          "text": "Viiden vuoden ajan."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: How long may someone who has committed drunk driving not apply for a taxi driving licence?\nA: For three years.\nB: For one year.\nC: For five years.\n\n--- Keywords ---\nViiden vuoden ajan = for five years\nrattijuopumus = drunk driving\ntaksiajolupa = taxi driving licence\nhakea = to apply\n\n--- Explanation ---\nAfter drunk driving, you cannot apply for a taxi licence for five years.\n\nCorrect answer: C"
    },
    {
      "id": 120,
      ...
      "options": [
        {
          "letter": "A",
          "text": "Terveydentilaa ei tarvitse todentaa millään tavalla."
        },
        {
          "letter": "B",
          "text": "Lääkärin tarkastuksella ja siitä saatavalla todistuksella taksinkuljettajan ajolupaa hakiessa."
        },
        {
          "letter": "C",
          "text": "Omalla kirjallisella terveydentilaa koskevalla raportilla."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 121,
      "text": "Taksinkuljettajan ajoluvan voi peruuttaa?",
      "options": [
        {
          "letter": "A",
        ...
        {
          "letter": "C",
          "text": "Liikenne- ja viestintävirasto."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Who can revoke a taxi driver's licence?\nA: The local taxi association.\nB: The police.\nC: The Transport and Communications Agency.\n\n--- Keywords ---\nPoliisi = police\nperuuttaa = revoke\najolupa = driving licence\nTraficom = Transport and Communications Agency\n\n--- Explanation ---\nThe police can revoke a taxi driver's licence.\n\nCorrect answer: B"
    },
    {
      "id": 122,
      "text": "Kuinka pitkään B-luokan ajooikeuden on pitänyt olla, jotta taksinkuljettajan ajolupa voidaan myöntää?",
      "options": [
        {
          "letter": "A",
          "text": "Vähintään kolmen vuoden ajan."
        },
        {
          "letter": "B",
          "text": "Vähintään viiden vuoden ajan."
        },
        {
          "letter": "C",
          "text": "Vähintään yhden vuoden ajan."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: How long must a category B driving licence have been held before a taxi driver's licence can be granted?\nA: For at least three years.\nB: For at least five years.\nC: For at least one year.\n\n--- Keywords ---\nVähintään yhden vuoden ajan = for at least one year\nB-luokan ajooikeus = category B driving licence\nmyöntää = grant / issue\najolupa = driving licence\n\n--- Explanation ---\nYou need at least one year of category B driving licence before getting a taxi licence.\n\nCorrect answer: C"
    },
    {
      "id": 124,
      "text": "Mikä viranomainen myöntää taksinkuljettajan ajoluvan?",
      "options": [
        {
          "letter": "A",
          "text": "TE-toimisto."
      ...
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: Which authority issues the taxi driver's licence?\nA: TE Office (employment office).\nB: Police.\nC: Transport and Communications Agency.\n\n--- Keywords ---\nLiikenne- ja viestintävirasto = Transport and Communications Agency (Traficom)\nmyöntää = issues\najolupa = driving licence\nPoliisi = police\n\n--- Explanation ---\nTraficom (Transport and Communications Agency) issues the taxi driver's licence.\n\nCorrect answer: C"
    },
    {
      "id": 125,
      "text": "Aino on aloittanut työvuoronsa 5.30. Hän on aina ollut aamuvirkku ihminen ja lähtee mielellään töihin aikaisin. Hänen aamunsakoostuu lähinnä muiden aamuvirkkujen kuljettamisesta työpaikalle. Noin puoli kahdeksan aikaan hän aloittaa koululaisten kuljetukset. Aamu kuluu mielenkiintoisissa monipuolisissa tehtävissä yleensä erittäin nopeasti. Milloin Ainon on pidettävä ensimmäinen tauko?",
      "options": [
        {
          "letter": "A",
          "text": "Viimeistään klo 11, sillä kuljettajan yhtämittainen työaika saa olla 5,5 tuntia."
        },
        {
          "letter": "B",
          "text": "Sitten kun hän tuntee itsensä väsyneeksi. Työaikalaki määrittelee, että tarkkailee jaksamistaan ja tauottaa työpäivänsä tarpeen mukaan."
        },
        {
          "letter": "C",
          "text": "Viimeistään klo 10, sillä kuljettajan yhtämittainen työaika saa olla 4,5 tuntia."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 126,
      "text": "Saako taksinkuljettaja työskennellä yhtäjaksoisesti 15 tuntia?",
      "options": [
        {
          "letter": "A",
          "text": "Kyllä, jos työtä ei voida muulla tavoin tarkoituksenmukaisesti järjestää."
        },
        {
          "letter": "B",
          "text": "Kyllä, jos työnantaja kuuluu taksiyritysten liittoon."
        },
        {
          "letter": "C",
          "text": "Kyllä, jos kuljettaja itse haluaa."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 128,
      "text": "Laissa liikenteen palveluista on lueteltu erilaisia laatuvaatimuksia. Mikä seuraavista vaihtoehdoista pitää paikkansa?",
      "options": [
        {
          "letter": "A",
          "text": "Laatuvaatimukset koskevat ainoastaan niitä yrittäjiä, joilla on enemmän kuin kaksi työntekijää vakituisesti."
        },
        {
          "letter": "B",
          "text": "Laatuvaatimukset koskevat ainoastaan taksiluvan haltijaa."
        },
        {
          "letter": "C",
          "text": "Laatuvaatimukset koskevat jokaista taksinkuljettajaa."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 129,
      "text": "Koskeeko liikenteen palveluista annettu laki (laatuvaatimukset) taksiyrittäjää?",
      "options": [
        {
          "letter": "A",
          "text": "Laatuvaatimukset koskevat ainoastaan taksiluvan haltijaa."
        ...
        {
          "letter": "C",
          "text": "Laatuvaatimukset koskevat ainoastaan niitä yrittäjiä, joilla on enemmän kuin kaksi työntekijää."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 134,
      "text": "Miksi on tärkeää pitää turvaväli edellä ajoneuvoon?",
      "options": [
        {
          "letter": "A",
          "text": "Turvavälin pitäminen edellä ajoneuvoon on turvallista."
        },
        {
          "letter": "B",
          "text": "Turvavälin pitäminen on turhaa."
        },
        {
          "letter": "C",
          "text": "Turvavälin pitäminen edellä ajoneuvoon on merkityksetöntä."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: Why is it important to keep a safe distance to the vehicle ahead?\nA: Keeping a safe distance to the vehicle ahead is safe.\nB: Keeping a safe distance is unnecessary.\nC: Keeping a safe distance to the vehicle ahead is meaningless.\n\n--- Keywords ---\nturvaväli = safe distance\nturvallista = safe\nedellä ajoneuvoon = to the vehicle ahead\nliikenne = traffic\n\n--- Explanation ---\nA safe following distance gives time to react and prevents rear-end collisions.\n\nCorrect answer: A"
    },
    {
      "id": 135,
      "text": "Kuinka kauan taksinkuljettajan irtisanomisaika on, kun työsuhde on kestänyt yli viisi vuotta?",
      "options": [
        {
          "letter": "A",
          "text": "7 päivää."
      ...
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: How long is a taxi driver's notice period when employment has lasted over five years?\nA: 7 days.\nB: 14 days.\nC: 1 month.\n\n--- Keywords ---\n1 kuukausi = 1 month\nyli viisi vuotta = over five years\nirtisanomisaika = notice period\ntyösuhde = employment\n\n--- Explanation ---\nAfter more than five years of employment, the notice period is one month.\n\nCorrect answer: C"
    },
    {
      "id": 138,
      "text": "30 Minute Picture 30 min",
      "options": [
        {
          "letter": "A",
          "text": "Pitää vain silloin, kun taksin valaisin on poistettu."
        },
        {
          "letter": "B",
          "text": "Pitää aina."
      ...
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: 30 Minute Picture 30 min\nA: Only when the taxi light has been removed.\nB: Always.\nC: Never.\n\n--- Keywords ---\nPitää aina = must always\ntaksivalaisin = taxi light / roof sign\n30 min = 30 minutes\nesillä = displayed / visible\n\n--- Explanation ---\nBased on the image context, the taxi sign/light must always be displayed.\n\nCorrect answer: B"
    },
    {
      "id": 140,
      "text": "Missä tilanteissa kuljettajan ei tarvitse käyttää turvavyötä?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan tulee ajaessaan aina käyttää turvavyötä."
    ...
    {
      "id": 142,
      "text": "Millä tavoin taksinkuljettajan tulee toimia liikenteessä, jotta hän täyttää tienkäyttäjän ennakointivelvollisuuden?",
      "options": [
        {
          "letter": "A",
          "text": "Taksinkuljettajan on tienkäyttäjänä ennakoitava toisten tienkäyttäjien toimintaa."
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Ei, kaista on varattu pelkästään linja-autoille."
        },
        {
          "letter": "B",
          "text": "Kyllä, lisäkilpi sallii myös taksin käyttää kaistaa."
        },
        {
          "letter": "C",
          "text": "Vain ruuhka-aikojen ulkopuolella."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 147,
      "text": "Mitä oheinen keltainen lisäkilpi (linja-auton kuva) tarkoittaa liikennemerkin  yhteydessä?",
      "options": [
        {
          "letter": "A",
          "text": "Merkki ei koske linja-autoja."
        },
        {
          "letter": "B",
          "text": "Merkki koskee vain linja-autoja tai joukkoliikennettä."
        },
        {
          "letter": "C",
          "text": "Linja-autopysäkki on poistettu käytöstä."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 148,
      "text": "Pitääkö taksivalaisimen olla esillä?",
      "options": [
        {
          "letter": "A",
          "text": "Pitää vain silloin, kun taksin valaisin on poistettu."
    ...
    {
      "id": 149,
      "text": "Mitä oheinen varoitusmerkki tarkoittaa?",
      "options": [
        {
          "letter": "A",
          "text": "Tietöitä."
        ...
        {
          "letter": "B",
          "text": "Töyssy (epätasainen tie / hidastetöyssy)."
        },
        {
          "letter": "C",
          "text": "Liukas ajorata."
    ...
    {
      "id": 150,
      "text": "Ajaessasi taksia, saatko ajaa ajoneuvon kyseisen liikennemerkin  (moottorikäyttöisellä ajoneuvolla ajo kielletty) vaikutusalueelle?",
      "options": [
        {
          "letter": "A",
          "text": "Aina ajaessani taksia."
    ...
    {
      "id": 151,
      "text": "Mitä oheinen liikennemerkki tarkoittaa (yhdistetty pyörätie ja jalkakäytävä,  rinnakkain)?",
      "options": [
        {
          "letter": "A",
          "text": "Pyöräilijöille ja jalankulkijoille on omat, viivalla erotetut osansa."
        },
        {
          "letter": "B",
          "text": "Tie on tarkoitettu vain pyöräilijöille."
        },
        {
          "letter": "C",
          "text": "Tie on tarkoitettu vain jalankulkijoille."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 152,
      "text": "Kuva on otettu taksin sisältä moottoritiellä toisen ajoneuvon perässä  ajettaessa. Mikä seuraavista on oikein turvavälistä?",
      "options": [
        {
          "letter": "A",
          "text": "Riittävä turvaväli edellä ajavaan parantaa turvallisuutta ja antaa aikaa reagoida."
        },
        {
          "letter": "B",
          "text": "Turvavälin pitäminen on tarpeetonta moottoritiellä."
        },
        {
          "letter": "C",
          "text": "Mitä pienempi turvaväli, sitä turvallisempaa ajaminen on."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 153,
      "text": "Milloin saat ajaa taksilla oheisella liikennemerkillä (moottoriajoneuvolla ajo kielletty)  merkityllä kadulla?",
      "options": [
        {
          "letter": "A",
          "text": "Kun olet menossa kadun varrella olevalle kiinteistölle."
        },
        {
          "letter": "B",
          "text": "Taksilla on läpiajo-oikeus."
        },
        {
          "letter": "C",
          "text": "Et koskaan."
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "letter": "C",
          "text": "Aina jos nouden tai tuon asiakkaan."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 155,
      "text": "Pitääkö taksivalaisimen olla esillä? [laadittu epäselvän kuvan perusteella]",
      "options": [
        {
          "letter": "A",
          "text": "Pitää vain silloin, kun taksin valaisin on poistettu."
    ...
    {
      "id": 156,
      "text": "Pitääkö taksivalaisimen olla esillä? [laadittu kuvan/vastauksen perusteella]",
      "options": [
        {
          "letter": "A",
          "text": "Pitää vain silloin, kun taksin valaisin on poistettu."
    ...
    {
      "id": 160,
      "text": "Mikä seuraavista vaihtoehdoista on oikein?",
      "options": [
        {
          "letter": "A",
          "text": "Taksiluvan haltija on oikeus poikkeustapauksessa ohittaa kuljettajan alkolukon käyttövelvollisuus."
        },
        {
          "letter": "B",
          "text": "Alkoholi ei tule nauttia ennen ajovuoroa, koska nautittu alkoholi aiheuttaa aina väsymystä ja heikentää ajokykyä."
        },
        {
          "letter": "C",
          "text": "Jos kuljettaja ei saa puhalluksen jälkeen ajoneuvoa käyntiin, kuljettaja voi aina vaihtaa sellaiseen ajoneuvoon jossa ei ole alkolukkoa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 181,
      "text": "olet viemässä tuttua asiakasta paikalliseen elokuvateatteriin, kun yhtäkkiä huomaat, että asiakas saa kouristuskohtauksen asiakas on sinulle entuudestaan tuttu joten tiedät asiakkaan sairastavan epilaspi. Mikä on ensimmäinen ensiaputoimenpiteesi?",
      "options": [
        {
          "letter": "A",
          "text": "Pidän tiukasti kiinni asiakkaasta, jotta hän ei satuttaisi itseään kouristuskohtauksen aikana."
        },
        {
          "letter": "B",
          "text": "Huolehdit, että asiakas ei kolhi päätään, mutta et pyri estämään kuoristusliikkeita kun kouristukset vähentyvät käännät henkilö kylkiasentoon."
        },
        {
          "letter": "C",
          "text": "Jatkat normaalisti matkaa, koska aikataulusi on tiukka ja arvelet että kohtauksen Menevän ohi."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 189,
      "text": "Milloin taksissa tulee olla alkolukko?",
      "options": [
        {
          "letter": "A",
          "text": "Aina, kun suoritetaan kunnan tilaamia koulu-ja päivähoitokuljetuksiin."
        },
        {
          "letter": "B",
          "text": "Aina, kun asiakas otetaan kyytiin ilman ennakkotilausta."
        },
        {
          "letter": "C",
          "text": "Vain jos kuljettajalla on taksinkuljettajan ajoluvassa alkolukko vastaava erityisehto."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: When must a taxi have an alcohol interlock?\nA: Always when carrying out municipal school and daycare transport.\nB: Always when picking up a customer without prior booking.\nC: Only if the driver's licence has a special alcohol interlock condition.\n\n--- Keywords ---\nalkolukko = alcohol interlock\nkoulu- ja päivähoitokuljetus = school and daycare transport\nkunnan tilaama = municipal ordered\naina = always\n\n--- Explanation ---\nAn alcohol interlock is mandatory for municipal school and daycare transport.\n\nCorrect answer: A"
    },
    {
      "id": 195,
      "text": "Mikä seuraavista väittämistä on oikein, kun kuljettaja käyttää alkoholia ennen työvuoroa?",
      "options": [
        {
          "letter": "A",
          "text": "Alkoholia voi nauttia, jos se ei vaikuta ajokykyyn."
        },
        {
          "letter": "B",
          "text": "Alkoholi aiheuttaa aina väsymystä ja heikentää ajokykyä, joten sitä ei tule nauttia ennen työvuoroa."
        },
        {
          "letter": "C",
          "text": "Kuljettaja voi vaihtaa ajoneuvoon, jossa ei ole alkolukkoa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 197,
      "text": "Mikä seuraavista väittämistä on oikein taksinkuljettajan työaikojen suhteen?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja saa työskennellä yhtäjaksoisesti 15 tuntia, jos hän itse haluaa."
        },
        {
          "letter": "B",
          "text": "Kuljettajan yhtämittainen työaika saa olla enintään 5,5 tuntia."
        },
        {
          "letter": "C",
          "text": "Kuljettajan yhtämittainen työaika saa olla enintään 4,5 tuntia."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 198,
      "text": "Mikä seuraavista on oikein liikenteen poikkeusjärjestelyissä?",
      "options": [
        {
          "letter": "A",
          "text": "Noudata aina liikenteenohjaajan ohjeita."
        },
        {
          "letter": "B",
          "text": "Noudata poliisin ohjeita, jos liikenteenohjaajaa ei ole paikalla."
        },
        {
          "letter": "C",
          "text": "Noudata omia arvioitasi, jos ohjeita ei ole saatavilla."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Which of the following is correct in exceptional traffic arrangements?\nA: Always follow the traffic controller's instructions.\nB: Follow police instructions if no traffic controller is present.\nC: Follow your own judgment if no instructions are available.\n\n--- Keywords ---\npoliisi = police\nliikenteenohjaaja = traffic controller\npoikkeusjärjestely = exceptional arrangement\nnoudattaa = to follow\n\n--- Explanation ---\nFollow the traffic controller when present; otherwise follow police instructions.\n\nCorrect answer: B"
    },
    {
      "id": 200,
      "text": "Miten toimit, kun ajoneuvon rengas puhkeaa kesken ajon?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkat matkaa hitaasti."
        },
        {
          "letter": "B",
          "text": "Pysähdyt turvalliseen paikkaan ja vaihdat renkaan."
        },
        {
          "letter": "C",
          "text": "Soitat huoltopalveluun ja odotat apua."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do when a tyre punctures during driving?\nA: Continue driving slowly.\nB: Stop in a safe place and change the tyre.\nC: Call roadside assistance and wait for help.\n\n--- Keywords ---\nrengas puhkeaa = tyre punctures\nturvalliseen paikkaan = safe place\nvaihdat renkaan = change the tyre\nPysähdyt = you stop\n\n--- Explanation ---\nStop safely and change the tyre. Do not continue on a flat tyre.\n\nCorrect answer: B"
    },
    {
      "id": 211,
      "text": "Miten varmistat ajoneuvon kunnon ennen ajovuoron alkamista?",
      "options": [
        {
          "letter": "A",
          "text": "Varmistat vain, että polttoainetta on riittävästi."
        },
        {
          "letter": "B",
          "text": "Tarkistat vain renkaiden ilmanpaineet."
        },
        {
          "letter": "C",
          "text": "Tarkistat ajoneuvon yleiskunnon, kuten renkaat, valot, jarrut ja muut turvallisuustekijät."
        }
      ],
      "correct": "C",
      "explanation": "Answer: C\n\n--- English Translation ---\nQuestion: How do you ensure the vehicle's condition before a shift starts?\nA: You only ensure there is enough fuel.\nB: You only check tyre pressures.\nC: You check overall condition: tyres, lights, brakes, and other safety factors.\n\n--- Keywords ---\nyleiskunto = overall condition\nrenkaat = tyres\njarrut = brakes\nvalot = lights\nturvallisuustekijät = safety factors\n\n--- Explanation ---\nPre-shift check must cover tyres, lights, brakes, and overall safety — not just fuel.\n\nCorrect answer: C"
    },
    {
      "id": 216,
      "text": "Liikenteessä on poikkeusjärjestelyjä onnettomuuden vuoksi. Kenellä on määräysvalta?",
      "options": [
        {
          "letter": "A",
          "text": "Liikennevirasto"
      ...
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: There are exceptional traffic arrangements due to an accident. Who has authority?\nA: Transport Infrastructure Agency\nB: Police\nC: Employer\n\n--- Keywords ---\nPoliisi = police\nmääräysvalta = authority\npoikkeusjärjestely = exceptional arrangement\nonnettomuus = accident\n\n--- Explanation ---\nIn exceptional traffic situations, the police have authority on the road.\n\nCorrect answer: B"
    },
    {
      "id": 238,
      "text": "Kuinka tarkistat ajoneuvon ennen ajovuoron alkamista varmistaaksesi sen turvallisuuden?",
      "options": [
        {
          "letter": "A",
          "text": "Tarkistat renkaiden ilmanpaineet, jarrujen toiminnan ja valojen kunnon."
        },
        {
          "letter": "B",
          "text": "Tarkistat vain polttoaineen määrän."
        },
        {
          "letter": "C",
          "text": "Varmistat, että ajoneuvo on pesty."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: How do you check the vehicle before a shift to ensure safety?\nA: You check tyre pressures, brake function, and light condition.\nB: You only check fuel level.\nC: You ensure the vehicle is washed.\n\n--- Keywords ---\nrenkaiden ilmanpaineet = tyre pressures\njarrut = brakes\nvalot = lights\najovuoro = shift\nturvallisuus = safety\n\n--- Explanation ---\nPre-shift checks must include tyres, brakes, and lights — not just fuel or cleanliness.\n\nCorrect answer: A"
    },
    {
      "id": 241,
      "text": "Kuinka usein ajoneuvon ensiapuvälineet tulee tarkistaa?",
      "options": [
        {
          "letter": "A",
          "text": "Vain vuosihuollon yhteydessä."
        },
        {
          "letter": "B",
          "text": "Säännöllisesti, vähintään kerran kuukaudessa."
        },
        {
          "letter": "C",
          "text": "Ainoastaan silloin, kun niitä käytetään."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: How often must the vehicle's first-aid supplies be checked?\nA: Only during annual service.\nB: Regularly, at least once a month.\nC: Only when they are used.\n\n--- Keywords ---\nensiapuvälineet = first-aid supplies\nsäännöllisesti = regularly\nkerran kuukaudessa = once a month\ntarkistaa = to check\n\n--- Explanation ---\nFirst-aid supplies should be checked regularly — at least monthly.\n\nCorrect answer: B"
    },
    {
      "id": 243,
      "text": "Mitä teet, jos huomaat ajon aikana ajoneuvon mittariston varoitusvalon syttyvän?",
      "options": [
        {
          "letter": "A",
          "text": "Jatkat ajoa, jos ajoneuvo tuntuu toimivan normaalisti."
        },
        {
          "letter": "B",
          "text": "Pysäytät ajoneuvon turvalliseen paikkaan ja tarkistat varoituksen syyn."
        },
        {
          "letter": "C",
          "text": "Ohitat varoitusvalon, jos et ole varma sen merkityksestä."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: What do you do if a dashboard warning light comes on during driving?\nA: Continue driving if the vehicle seems to work normally.\nB: Stop in a safe place and check the cause of the warning.\nC: Ignore the warning if you are unsure what it means.\n\n--- Keywords ---\nvaroitusvalo = warning light\nmittaristo = dashboard\nPysäytät = you stop\nturvalliseen paikkaan = safe place\ntarkistat = you check\n\n--- Explanation ---\nStop safely and investigate a dashboard warning — do not ignore it.\n\nCorrect answer: B"
    },
    {
      "id": 251,
      "text": "Miten taksinkuljettaja voi parantaa ajoturvallisuutta talvella?",
      "options": [
        {
          "letter": "A",
          "text": "Käyttämällä aina kesärenkaita."
        },
        {
          "letter": "B",
          "text": "Varmistamalla, että ajoneuvossa on talvirenkaat ja ajamalla hitaammin."
        },
        {
          "letter": "C",
          "text": "Pysäköimällä ajoneuvo sisätiloihin."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: How can a taxi driver improve driving safety in winter?\nA: By always using summer tyres.\nB: By ensuring the vehicle has winter tyres and driving more slowly.\nC: By parking the vehicle indoors.\n\n--- Keywords ---\ntalvirenkaat = winter tyres\najoturvallisuus = driving safety\ntalvella = in winter\nhitaammin = more slowly\nkesärenkaat = summer tyres\n\n--- Explanation ---\nIn winter, use winter tyres and reduce speed for safer driving.\n\nCorrect answer: B"
    },
    {
      "id": 252,
      "text": "Liikenneonnettomuuden vuoksi on poikkeusjärjestelyt ja saat ristiriitaisia ohjeita kolmelta taholta. Kenen ohjeita noudatat?",
      "options": [
        {
          "letter": "A",
          "text": "Liikennevirasto"
      ...
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Due to an accident there are exceptional arrangements and you receive conflicting instructions from three parties. Whose instructions do you follow?\nA: Transport Infrastructure Agency\nB: Police\nC: Employer\n\n--- Keywords ---\nPoliisi = police\nristiriitaisia ohjeita = conflicting instructions\npoikkeusjärjestelyt = exceptional arrangements\nmääräysvalta = authority\n\n--- Explanation ---\nWhen instructions conflict, follow the police.\n\nCorrect answer: B"
    },
    {
      "id": 280,
      "text": "Kuinka paljon taksissa saa enintään ylittää istuinpaikkaluvun, jos kyseessä ei ole koulu- ja päiväkotikuljetus?",
      "options": [
        {
          "letter": "A",
          "text": "Ei yhtään"
        ...
        {
          "letter": "C",
          "text": "Kuljettajan harkinnan mukaan"
        }
      ],
      "correct": "A",
    ...
    {
      "id": 282,
      "text": "Aulis sai taksinkuljettajan ajoluvan Vantaalla, mutta muuttaa Jyväskylään. Voiko hän aloittaa siellä?",
      "options": [
        {
          "letter": "A",
          "text": "Ei, lupa on vain 2 vuotta voimassa."
        },
        {
          "letter": "B",
          "text": "Kyllä, mutta vasta paikallistuntemuskokeen jälkeen ja haettuaan luvan laajennusta."
        },
        {
          "letter": "C",
          "text": "Kyllä, lupa on voimassa koko Manner-Suomessa."
        }
      ],
      "correct": "B",
      "explanation": "Answer: B\n\n--- English Translation ---\nQuestion: Aulis got his taxi licence in Vantaa but is moving to Jyväskylä. Can he start working there?\nA: No, the licence is valid only 2 years.\nB: Yes, but only after a local knowledge test and applying for licence area extension.\nC: Yes, the licence is valid throughout mainland Finland.\n\n--- Keywords ---\npaikallistuntemus = local knowledge\nluvan laajennus = licence extension\nJyväskylä = Jyväskylä\najolupa = driving licence\nManner-Suomi = mainland Finland\n\n--- Explanation ---\nMoving to a new area requires passing local knowledge and extending the licence area with Traficom.\n\nCorrect answer: B"
    },
    {
      "id": 283,
      "text": "Missä tilanteessa kuljettaja voi kieltäytyä kyydistä?",
      "options": [
        {
          "letter": "A",
          "text": "Jos kyyti suuntautuu toiselle liikennealueelle."
        },
        {
          "letter": "B",
          "text": "Jos laillinen työaika ylittyisi."
        },
        {
          "letter": "C",
          "text": "Jos asiakas menee toisen kunnan alueelle."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 284,
      "text": "Kallen työsuhde on kestänyt yli vuoden mutta alle 5 vuotta. Mikä on hänen irtisanomisaikansa?",
      "options": [
        {
          "letter": "A",
          "text": "14 päivää"
    ...
    {
      "id": 288,
      "text": "Missä tilanteissa kuljettajan nimi pitää olla esillä taksissa?",
      "options": [
        {
          "letter": "A",
          "text": "Vain ennakkotilausajoissa."
        },
        {
          "letter": "B",
          "text": "Kaikissa kuljetuksissa."
        ...
        {
          "letter": "C",
          "text": "Vain koulu- ja päiväkotikuljetuksissa."
        }
      ],
      "correct": "B",
    ...
    {
      "id": 289,
      "text": "Mikä on peruste ajoluvan peruuttamiselle?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettaja ei ole työskennellyt kolmeen vuoteen."
        },
        {
          "letter": "B",
          "text": "Alueen taksiyrittäjät suosittelevat peruuttamista."
        },
        {
          "letter": "C",
          "text": "Kuljettaja on syyllistynyt törkeään liikenneturvallisuuden vaarantamiseen."
    ...
    {
      "id": 290,
      "text": "Mikä työaikaa koskeva väite ei pidä paikkaansa?",
      "options": [
        {
          "letter": "A",
          "text": "Vuorokautinen työaika max 11 h / 24 h."
        },
        {
          "letter": "B",
          "text": "Työaikaan kuuluu myös taksiasemalla olo ja auton siivoaminen."
        },
        {
          "letter": "C",
          "text": "Työaikaan ei lasketa työpäivän kahden tunnin taukoa."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 291,
      "text": "Mikä väittämä on virheellinen?",
      "options": [
        {
          "letter": "A",
          "text": "Ajoneuvon tulee olla rekisteröity luvanvaraiseen liikenteeseen."
        },
        {
          "letter": "B",
          "text": "Kuljettajalla pitää aina olla ajolupa mukana."
        },
        {
          "letter": "C",
          "text": "Jokaisessa taksissa tulee olla alkolukko."
    ...
    {
      "id": 293,
      "text": "Kenen vastuulla on työvuorossa käytettävän taksin liikennekelpoisuus?",
      "options": [
        {
          "letter": "A",
          "text": "Kuljettajan."
      ...
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: Who is responsible for the roadworthiness of the taxi used during a shift?\nA: The driver's.\nB: The taxi inspector's.\nC: The vehicle inspector's.\n\n--- Keywords ---\nKuljettajan = driver's\nliikennekelpoisuus = roadworthiness\ntyövuoro = shift\nvastuulla = responsibility\n\n--- Explanation ---\nThe driver is responsible for the taxi's roadworthiness during their shift.\n\nCorrect answer: A"
    },
    {
      "id": 296,
      "text": "Mitä kuljettajan ajopäiväkirjaan merkitään?",
      "options": [
        {
          "letter": "A",
          "text": "Työvuoron aloitus ja tauot."
        },
        {
          "letter": "B",
          "text": "Tauot ja niiden aikana nautittu ravinto."
        ...
        {
          "letter": "C",
          "text": "Lyhyt selvitys työssä tapahtuneista ongelmista."
        }
      ],
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: What is recorded in the driver's logbook?\nA: Start of shift and breaks.\nB: Breaks and food consumed during them.\nC: Brief report of problems at work.\n\n--- Keywords ---\najopäiväkirja = driving logbook\ntauot = breaks\ntyövuoron aloitus = start of shift\nmerkitään = is recorded\n\n--- Explanation ---\nThe logbook records shift start and break times.\n\nCorrect answer: A"
    },
    {
      "id": 298,
      "text": "Ennakoivan ajotavan tärkein tavoite on?",
      "options": [
        {
          "letter": "A",
          "text": "Osata toimia onnettomuuden sattuessa."
        },
        {
          "letter": "B",
          "text": "Olla valmis vaaratilanteissa."
        },
        {
          "letter": "C",
          "text": "Pyrkiä ajamaan niin, ettei jouduta vaara- tai onnettomuustilanteisiin."
        }
      ],
      "correct": "C",
    ...
    {
      "id": 299,
      "text": "Polkupyöräilijä kaatuu edessäsi ja jää liikkumattomana tielle. Mikä on ensimmäinen ensiaputoimenpide?",
      "options": [
        {
          "letter": "A",
          "text": "Hengitysteiden avaaminen."
        ...
        {
          "letter": "B",
          "text": "Tutkia murtumia."
        },
        {
          "letter": "C",
          "text": "Siirtää turvallisempaan paikkaan."
        }
      ],
      "correct": "A",
    ...
    {
      "id": 300,
      "text": "Miten taksinkuljettajaksi hakevan terveysvaatimukset osoitetaan?",
      "options": [
        {
          "letter": "A",
          "text": "Lääkärintodistuksella."
        },
        {
          "letter": "B",
          "text": "Omalla kirjallisella raportilla."
        },
        {
          "letter": "C",
          "text": "Ei tarvitse osoittaa."
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "correct": "A",
      "explanation": "Answer: A\n\n--- English Translation ---\nQuestion: Who can revoke a taxi driver's driving licence?\nA: Police\nB: Local taxi association\nC: Transport and Communications Agency (Traficom)\n\n--- Keywords ---\nPoliisi = police\nperuuttaa = revoke\najolupa = driving licence\nTraficom = Transport and Communications Agency\ntaksinkuljettaja = taxi driver\n\n--- Explanation ---\nThe police can revoke a taxi driver's licence.\n\nCorrect answer: A"
    },
    {
      "id": 302,
      "text": "Kuinka pitkään B-ajokortti pitää olla ollut voimassa, ennen kuin voi saada taksiajoluvan?",
      "options": [
        {
          "letter": "A",
          "text": "Vähintään 1 vuoden"
        },
        {
          "letter": "B",
          "text": "Vähintään 3 vuotta"
        },
        {
          "letter": "C",
    ...
    {
      "id": 305,
      "text": "Aino aloitti työvuoron klo 5:30. Milloin hänen on viimeistään pidettävä ensimmäinen tauko?",
      "options": [
        {
          "letter": "A",
          "text": "Kun tuntee itsensä väsyneeksi."
        },
        {
          "letter": "B",
          "text": "Viimeistään klo 11 (5,5 h yhtäjaksoista työaikaa)."
        },
        {
          "letter": "C",
          "text": "Viimeistään klo 10 (4,5 h yhtäjaksoista työaikaa)."
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "letter": "A",
          "text": "Kyllä, jos muuta järjestelyä ei ole."
        },
        {
          "letter": "B",
          "text": "Kyllä, jos kuljettaja haluaa."
        },
        {
          "letter": "C",
          "text": "Ei saa."
    ...
    {
      "id": 308,
      "text": "Laissa on laatuvaatimuksia takseille. Keitä ne koskevat?",
      "options": [
        {
          "letter": "A",
          "text": "Vain luvanhaltijaa."
        },
        {
          "letter": "B",
          "text": "Jokaista taksinkuljettajaa."
        },
        {
          "letter": "C",
          "text": "Vain yrittäjiä, joilla on yli 2 työntekijää."
        }
      ],
      "correct": "B",
