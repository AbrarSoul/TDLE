...
const TRIGGERS = {
  ...
  101: { trigger: 'alle viisi vuotta / 14 päivää', rule: 'Taxi driver notice period under 5 years = 14 days. Over 5 years = 1 month (see Q135).' },
  135: { trigger: 'yli viisi vuotta / 1 kuukausi', rule: 'Taxi driver notice period over 5 years = 1 month. Under 5 years = 14 days (see Q101).' },
  188: { trigger: 'neljä vuoden / alle viisi vuotta', rule: 'Four years is under five years → 14 days notice period. Reject 1 month and waiting for replacement driver.' },
  284: { trigger: 'yli vuoden mutta alle 5 vuotta', rule: 'Still under five years → 14 days, not 1 month. Reject until employer finds replacement.' },
