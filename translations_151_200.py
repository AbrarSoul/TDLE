"""English translations for quiz questions 151-200."""

TRANSLATIONS_151_200 = {
    151: {
        ...
        "simple": "The sign shows a combined path with separate marked sections for cyclists and pedestrians.",
    },
    152: {
        ...
        "simple": "A proper following distance on the motorway gives you time to react safely.",
    },
    153: {
        ...
        "simple": "You may enter the street when accessing a property along it, not for through traffic.",
    },
    154: {
    ...
    156: {
        ...
        "simple": "The taxi sign/light must always be on during taxi operations.",
    },
    157: {
        ...
        "simple": "In this image version, the lane is for buses only — the TAKSI plate is not shown as allowing taxi use.",
    },
    158: {
        ...
        "simple": (
            ...
            "Therefore, the total fare is €65.00 (Nearest to €66.00), assuming there are no "
    ...
    159: {
        ...
        "simple": "The driver must ensure safe exit. If the requested spot is unsafe, choose a safer nearby location.",
    },
    160: {
        ...
        "simple": "Do not drink alcohol before a shift — it impairs driving even if you feel fine.",
    },
    161: {
    ...
    162: {
        ...
        "simple": "Children under 135 cm must always use an approved child restraint in a taxi.",
    },
    163: {
        ...
        "simple": "Sign language is not required. The driver must still get the customer to the destination safely.",
    },
    164: {
        ...
        "simple": "Phone calls while driving are allowed only with hands-free and only when necessary for the transport.",
    },
    165: {
        ...
        "simple": "You cannot transport a 3-year-old without a proper restraint. Arrange a suitable vehicle instead.",
    },
    166: {
        ...
        "simple": "Per exam material, option B reflects the applicable wheelchair securing rule in this question set.",
    },
    167: {
        ...
        "simple": "Apply brakes and secure the wheelchair from the frame at four attachment points.",
    },
    168: {
        ...
        "simple": "A guide dog stays in the footwell or luggage area. Do not distract or pet it.",
    },
    169: {
        ...
        "simple": "School transport drivers ensure seat belts and model responsible behaviour — not homework or constant parent calls.",
    },
    170: {
        ...
        "simple": "The driver helps the customer board and handles luggage safely, even with an assistant present.",
    },
    171: {
        ...
        "simple": "In school transport, act as a responsible adult and good role model for children.",
    },
    172: {
        ...
        "simple": "The driver must wear a seat belt in school transport, setting an example for children.",
    },
    173: {
    ...
    174: {
        ...
        "simple": "Get out and ask if they need help. Do not grab or rush them without consent.",
    },
    175: {
        ...
        "simple": "In this question set, the driver obtains the criminal record extract (answer B).",
    },
    176: {
        ...
        "simple": "Ask how to help and describe where the taxi is. Do not shout or grab without asking.",
    },
    177: {
        ...
        "simple": "Announce your arrival, introduce yourself, describe the taxi location, and ask how to help.",
    },
    178: {
        ...
        "simple": "Ensure the customer is handed over to care staff — responsibility does not end in the yard.",
    },
    179: {
    ...
    180: {
        ...
        "simple": "For Kela rides, the customer pays at most their deductible — here 25 euros.",
    },
    181: {
        ...
        "simple": "Protect the head, do not restrain convulsions, and place the person on their side when the seizure eases.",
    },
    182: {
        ...
        "simple": "Help ensure comfort, including adjusting clothes when the customer needs it.",
    },
    183: {
        ...
        "simple": "Customers may complain about poor service. Politeness is always required.",
    },
    184: {
        ...
        "simple": "Greet politely and let the customer decide whether and what to talk about.",
    },
    185: {
        ...
        "simple": "A guardian's permission does not override the law. Ensure an unaccompanied child uses a seat belt.",
    },
    186: {
        ...
        "simple": "In extreme cold, ensure the customer gets safely indoors before you leave.",
    },
    187: {
        ...
        "simple": "Read the customer's mood — some want to talk, others prefer quiet.",
    },
    188: {
    ...
    189: {
        ...
        "simple": "An alcohol interlock is mandatory for municipal school and daycare transport.",
    },
    190: {
    ...
    192: {
        ...
        "simple": "Communication devices may be used only when the vehicle is stopped.",
    },
    193: {
        ...
        "simple": "Offer card payment as an alternative when cash is a problem.",
    },
    194: {
        ...
        "simple": "Sufficient language skill means enough to serve customers and do the job — not fluent small talk or a foreign language requirement.",
    },
    195: {
        ...
        "simple": "Do not drink before a shift. Alcohol impairs driving regardless of how you feel.",
    },
    196: {
        "question": "When must a receipt be offered for a taxi ride?",
        "options": {
        ...
        "simple": "A receipt must always be provided — not only for app bookings or fixed fares.",
    },
    197: {
        ...
        "simple": "Maximum continuous working time is 5.5 hours before a break is required.",
    },
    198: {
        ...
        "simple": "Follow the traffic controller when present; otherwise follow police instructions.",
    },
    199: {
        ...
        "simple": "Try to return forgotten items to the customer first.",
    },
    200: {
        ...
        "simple": "Stop safely and change the tyre. Do not continue on a flat tyre.",
    },
}
